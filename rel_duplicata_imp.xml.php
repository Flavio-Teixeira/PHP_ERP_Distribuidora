<?php
<object class="relduplicataimp" name="relduplicataimp" baseclass="page">
  ...
  <property name="Name">relduplicataimp</property>
  <property name="Width">784</property>
  <property name="OnCreate">relduplicataimpCreate</property>
  <property name="jsOnLoad">relduplicataimpJSLoad</property>
  ...
  <object class="Label" name="relatorio_titulo" >
    <property name="Alignment">agCenter</property>
    <property name="Caption"><![CDATA[Relatorio de Cobranca - Duplicatas]]></property>
    <property name="Font">
