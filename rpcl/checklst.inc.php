...
//                }
                ...
                echo "    <table cellpadding=\"0\" cellspacing=\"0\" title=\"$hinttext\" ".($style!=""?"style=\"$style\"":"")." $class $attributes>";
                ...
                echo "    </table>\n";*/
                        ...
                        if($Mbox)
                          $spanstyle.="height:{$rowHeight}px;white-space:nowrap;";
                                ...
                                for($column=0; $column<$itemsPerRow; ++ $column)
                                {
                                        ...
                                        if($curItemNum<$numItems)
                                        {
                                                ...
                                                if(!$Mbox)
                                                {
                                                  ...
                                                  {
                                                        echo "      <td width=\"20\" style=\" color:$this->_headercolor; background-color:$this->_headerbackgroundcolor \"><input ID=\"$element\" type=\"checkbox\" style=\"  visibility:hidden\" $nestedattributes ></input></td>\n";
                                                  ...
                                                  else
                                                  {
                                                        ...
                                                        $checked = ((isset($this->_checked[$key])) && ($this->_checked[$key]==1)) ? "checked=\"checked\"" : "";
                                                        echo "      <td width=\"20\"><input ID=\"$element\" type=\"checkbox\" name=\"$this->Name[$key]\" value=\"1\" $events $enabled $taborder $hint $class $checked $nestedattributes/></td>\n";
                                                  }
                                                }
                                                else
                                                {
                                                  echo "<td width=\"$columnsWidth\" colspan='2' style=\"height:{$rowHeight}px\" $alignment>";
                                                  $checked = ((isset($this->_checked[$key])) && ($this->_checked[$key]==1)) ? "checked=\"checked\"" : "";
                                                ...
                                                {
                                                  echo "<label for=\"$element\" $alignment $spanstyle $hinttext  $class>$item</label></td>\n";
                                                }
                                        }
                                        //echo "</td>\n";
                                }
