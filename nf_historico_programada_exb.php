...
//Class definition
class nfhistoricoprogramadaexb extends Page
{
...
?>
   ...
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cfop.focus();
     return false;
   }
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_12;
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_11;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_10;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_9;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_8;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_7;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_6;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_5;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_4;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_3;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_2;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_1;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_12
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_11
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_10
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_9
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_8
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_7
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_6
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_5
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_4
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_3
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_2
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_1
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_12.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_11.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_10.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_9.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_8.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_7.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_6.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_5.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_4.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_3.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_2.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_forma_1.value = '';
   document.nfhistoricoprogramadaexb.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_data_emissao
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_suframa.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_suframa_desconto_pis_cofins.focus();
     return false;
   }
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_suframa_desconto_pis_cofins;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_suframa_desconto_icms
   var digits="0123456789.,"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_numero.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_codigo.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_nome.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_razao_social.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_inscricao_estadual.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_inscricao_municipal.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_complemento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_bairro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_estado.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cep.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_pais.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fone.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fax.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_endereco_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_complemento_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_bairro_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cidade_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_estado_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cep_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_pais_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fone_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fax_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_endereco_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_complemento_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_bairro_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cidade_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_estado_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cep_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_pais_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fone_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fax_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_ddd.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fone_comercial.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fone_celular.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_fone_fax.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_email.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_site.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_natureza_operacao_imp.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_data_emissao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_numero.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_suframa_desconto_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cfop_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_nota.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_desconto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_data.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_data_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_emite_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_natureza_operacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_faturamento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_representante.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_nro_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_dt_vcto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_dup_vlr_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_observacao_adicional_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_tipo_transporte.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_razao_social.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_veiculo_placa.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_veiculo_estado.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_cnpj.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_insc_est.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_insc_mun.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_endereco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_complemento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_bairro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_cidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_estado.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_transportadora_cep.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_qtde.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_especie.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_marca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_vol_numero.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_peso_bruto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_peso_liquido.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_base_aliquota_icms_reduzida.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_desconto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_base_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_consumo.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_zerar_base_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_base_icms_sub.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_icms_sub.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_produtos.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_seguro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_outras_despesas.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfhistoricoprogramadaexb.mgt_nota_fiscal_valor_total.focus();
     return false;
   }
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_peso_liquido;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_peso_bruto;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_qtde
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cfop_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_cfop
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfhistoricoprogramadaexb.mgt_nota_fiscal_numero
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
<?php
   ...
   function bt_simClick($sender, $params)
   {
      ...
      $Comando_SQL = "select *,date_format(mgt_programada_data_emissao, '%d/%m/%Y') AS mgt_programada_data_emissao,date_format(mgt_programada_data, '%d/%m/%Y') AS mgt_programada_data,date_format(mgt_programada_data_entrega, '%d/%m/%Y') AS mgt_programada_data_entrega from mgt_programadas where mgt_programada_finalidade = '" . substr(trim($this->mgt_nota_fiscal_numero->Text),0,3) . "' And mgt_programada_numero = " . substr(trim($this->mgt_nota_fiscal_numero->Text),3);
      ...
      $Comando_SQL = "select * from mgt_programadas_produtos where mgt_programada_produto_finalidade = '" . substr(trim($this->mgt_nota_fiscal_numero->Text),0,3) . "' And mgt_programada_produto_numero_nota = " . substr(trim($this->mgt_nota_fiscal_numero->Text),3) . " Order By mgt_programada_produto_numero";
      ...
      echo 'window.location="nf_historico_programada.php";';
      echo "</script>";
   }
   ...
   function nfhistoricoprogramadaexbCreate($sender, $params)
   {
      ...
      if(trim($mgt_nota_fiscal_numero) != '')
      {
         ...
         $Comando_SQL .= "date_format(mgt_programada_data_emissao, '%d/%m/%Y') AS mgt_programada_data_emissao,date_format(mgt_programada_data, '%d/%m/%Y') AS mgt_programada_data,date_format(mgt_programada_data_entrega, '%d/%m/%Y') AS mgt_programada_data_entrega from mgt_programadas where mgt_programada_finalidade = '" . substr(trim($this->mgt_nota_fiscal_numero->Text),0,3) . "' And mgt_programada_numero = " . substr(trim($this->mgt_nota_fiscal_numero->Text),3);
         ...
         $this->mgt_nota_fiscal_endereco->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_endereco'];
         $this->mgt_nota_fiscal_complemento->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_complemento'];
         $this->mgt_nota_fiscal_bairro->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_bairro'];
         $this->mgt_nota_fiscal_cidade->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cidade'];
         $this->mgt_nota_fiscal_estado->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_estado'];
         $this->mgt_nota_fiscal_cep->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cep'];
         $this->mgt_nota_fiscal_pais->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_pais'];
         $this->mgt_nota_fiscal_fone->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone'];
         $this->mgt_nota_fiscal_fax->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fax'];

         //*** Endereco de Entrega ***
         $this->mgt_nota_fiscal_endereco_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_endereco_entrega'];
         $this->mgt_nota_fiscal_complemento_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_complemento_entrega'];
         $this->mgt_nota_fiscal_bairro_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_bairro_entrega'];
         $this->mgt_nota_fiscal_cidade_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cidade_entrega'];
         $this->mgt_nota_fiscal_estado_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_estado_entrega'];
         $this->mgt_nota_fiscal_cep_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cep_entrega'];
         $this->mgt_nota_fiscal_pais_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_pais_entrega'];
         $this->mgt_nota_fiscal_opcao_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_opcao_entrega'];
         $this->mgt_nota_fiscal_fone_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone_entrega'];
         $this->mgt_nota_fiscal_fax_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fax_entrega'];

         //*** Endereco de Cobranca ***
         $this->mgt_nota_fiscal_endereco_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_endereco_cobranca'];
         $this->mgt_nota_fiscal_complemento_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_complemento_cobranca'];
         $this->mgt_nota_fiscal_bairro_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_bairro_cobranca'];
         $this->mgt_nota_fiscal_cidade_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cidade_cobranca'];
         $this->mgt_nota_fiscal_estado_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_estado_cobranca'];
         $this->mgt_nota_fiscal_cep_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cep_cobranca'];
         $this->mgt_nota_fiscal_pais_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_pais_cobranca'];
         $this->mgt_nota_fiscal_opcao_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_opcao_cobranca'];
         $this->mgt_nota_fiscal_fone_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone_cobranca'];
         $this->mgt_nota_fiscal_fax_cobranca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fax_cobranca'];

         //*** Dados de Contato ***
         $this->mgt_nota_fiscal_contato->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_contato'];
         $this->mgt_nota_fiscal_ddd->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_ddd'];
         $this->mgt_nota_fiscal_fone_comercial->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone_comercial'];
         $this->mgt_nota_fiscal_fone_celular->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone_celular'];
         $this->mgt_nota_fiscal_fone_fax->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone_fax'];
         $this->mgt_nota_fiscal_email->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_email'];
         $this->mgt_nota_fiscal_site->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_site'];

         //*** Adicionais ***
         $this->mgt_nota_fiscal_tipo_faturamento->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_tipo_faturamento'];
         $this->mgt_nota_fiscal_data_emissao->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_data_emissao'];
         $this->mgt_nota_fiscal_suframa_desconto_icms->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_suframa_desconto_icms'];
         $this->mgt_nota_fiscal_suframa_desconto_pis_cofins->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_suframa_desconto_pis_cofins'];
         $this->mgt_nota_fiscal_suframa->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_suframa'];
         $this->mgt_nota_fiscal_cliente_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_desconto'];
         $this->mgt_nota_fiscal_data->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_data'];
         $this->mgt_nota_fiscal_data_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_data_entrega'];
         $this->mgt_nota_fiscal_emite_lote->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_emite_lote'];
         $this->mgt_nota_fiscal_ordem_compra->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_ordem_compra'];
         ...
         $this->mgt_nota_fiscal_natureza_operacao_imp->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_natureza_operacao_imp'];
         ...
         if(trim(GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_tipo_nota']) == '1')
         {
         ...
         $this->mgt_nota_fiscal_observacao_nota->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_nota'];
         $this->mgt_nota_fiscal_observacao_faturamento->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_faturamento'];

         $this->hd_nota_fiscal_imprime_observacao_nota->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_imprime_observacao_nota'];
         ...
         //*** Condicoes de Pagamento ***
         $this->mgt_nota_fiscal_banco->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_banco'];
         $this->mgt_nota_fiscal_representante->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_representante'];

         $this->hd_nota_fiscal_descricao_condicao_pgto->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_descricao_condicao_pgto'];
         ...
         $this->mgt_nota_fiscal_cliente_condicao_pgto_1->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_1'];
         $this->mgt_nota_fiscal_dup_nro_1->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_1'];
         $this->mgt_nota_fiscal_dup_dt_vcto_1->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_1'];
         $this->mgt_nota_fiscal_dup_vlr_1->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_1'];
         $this->mgt_nota_fiscal_dup_forma_1->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_1'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_2->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_2'];
         $this->mgt_nota_fiscal_dup_nro_2->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_2'];
         $this->mgt_nota_fiscal_dup_dt_vcto_2->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_2'];
         $this->mgt_nota_fiscal_dup_vlr_2->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_2'];
         $this->mgt_nota_fiscal_dup_forma_2->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_2'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_3->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_3'];
         $this->mgt_nota_fiscal_dup_nro_3->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_3'];
         $this->mgt_nota_fiscal_dup_dt_vcto_3->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_3'];
         $this->mgt_nota_fiscal_dup_vlr_3->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_3'];
         $this->mgt_nota_fiscal_dup_forma_3->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_3'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_4->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_4'];
         $this->mgt_nota_fiscal_dup_nro_4->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_4'];
         $this->mgt_nota_fiscal_dup_dt_vcto_4->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_4'];
         $this->mgt_nota_fiscal_dup_vlr_4->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_4'];
         $this->mgt_nota_fiscal_dup_forma_4->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_4'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_5->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_5'];
         $this->mgt_nota_fiscal_dup_nro_5->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_5'];
         $this->mgt_nota_fiscal_dup_dt_vcto_5->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_5'];
         $this->mgt_nota_fiscal_dup_vlr_5->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_5'];
         $this->mgt_nota_fiscal_dup_forma_5->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_5'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_6->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_6'];
         $this->mgt_nota_fiscal_dup_nro_6->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_6'];
         $this->mgt_nota_fiscal_dup_dt_vcto_6->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_6'];
         $this->mgt_nota_fiscal_dup_vlr_6->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_6'];
         $this->mgt_nota_fiscal_dup_forma_6->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_6'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_7->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_7'];
         $this->mgt_nota_fiscal_dup_nro_7->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_7'];
         $this->mgt_nota_fiscal_dup_dt_vcto_7->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_7'];
         $this->mgt_nota_fiscal_dup_vlr_7->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_7'];
         $this->mgt_nota_fiscal_dup_forma_7->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_7'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_8->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_8'];
         $this->mgt_nota_fiscal_dup_nro_8->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_8'];
         $this->mgt_nota_fiscal_dup_dt_vcto_8->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_8'];
         $this->mgt_nota_fiscal_dup_vlr_8->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_8'];
         $this->mgt_nota_fiscal_dup_forma_8->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_8'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_9->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_9'];
         $this->mgt_nota_fiscal_dup_nro_9->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_9'];
         $this->mgt_nota_fiscal_dup_dt_vcto_9->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_9'];
         $this->mgt_nota_fiscal_dup_vlr_9->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_9'];
         $this->mgt_nota_fiscal_dup_forma_9->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_9'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_10->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_10'];
         $this->mgt_nota_fiscal_dup_nro_10->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_10'];
         $this->mgt_nota_fiscal_dup_dt_vcto_10->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_10'];
         $this->mgt_nota_fiscal_dup_vlr_10->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_10'];
         $this->mgt_nota_fiscal_dup_forma_10->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_10'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_11->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_11'];
         $this->mgt_nota_fiscal_dup_nro_11->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_11'];
         $this->mgt_nota_fiscal_dup_dt_vcto_11->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_11'];
         $this->mgt_nota_fiscal_dup_vlr_11->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_11'];
         $this->mgt_nota_fiscal_dup_forma_11->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_11'];

         $this->mgt_nota_fiscal_cliente_condicao_pgto_12->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_cliente_condicao_pgto_12'];
         $this->mgt_nota_fiscal_dup_nro_12->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_nro_12'];
         $this->mgt_nota_fiscal_dup_dt_vcto_12->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_dt_vcto_12'];
         $this->mgt_nota_fiscal_dup_vlr_12->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_vlr_12'];
         $this->mgt_nota_fiscal_dup_forma_12->Value = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_dup_forma_12'];

         //*** Observacoes Adicionais ***
         $this->mgt_nota_fiscal_observacao_adicional_1->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_1'];
         $this->mgt_nota_fiscal_observacao_adicional_2->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_2'];
         $this->mgt_nota_fiscal_observacao_adicional_3->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_3'];
         $this->mgt_nota_fiscal_observacao_adicional_4->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_4'];
         $this->mgt_nota_fiscal_observacao_adicional_5->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_5'];
         $this->mgt_nota_fiscal_observacao_adicional_6->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_6'];
         $this->mgt_nota_fiscal_observacao_adicional_7->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_7'];
         $this->mgt_nota_fiscal_observacao_adicional_8->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_8'];
         $this->mgt_nota_fiscal_observacao_adicional_9->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_9'];
         $this->mgt_nota_fiscal_observacao_adicional_10->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_observacao_adicional_10'];

         //*** Transportador ***
         $this->mgt_nota_fiscal_pagamento_frete->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_pagamento_frete'];
         $this->mgt_nota_fiscal_tipo_transporte->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_tipo_transporte'];
         $this->mgt_nota_fiscal_transportadora->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora'];
         $this->mgt_nota_fiscal_transportadora_razao_social->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_razao_social'];
         $this->mgt_nota_fiscal_transportadora_veiculo_placa->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_veiculo_placa'];
         $this->mgt_nota_fiscal_transportadora_veiculo_estado->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_veiculo_estado'];
         $this->mgt_nota_fiscal_transportadora_cnpj->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_cnpj'];
         $this->mgt_nota_fiscal_transportadora_insc_est->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_insc_est'];
         $this->mgt_nota_fiscal_transportadora_insc_mun->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_insc_mun'];
         $this->mgt_nota_fiscal_transportadora_endereco->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_endereco'];
         $this->mgt_nota_fiscal_transportadora_complemento->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_complemento'];
         $this->mgt_nota_fiscal_transportadora_bairro->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_bairro'];
         $this->mgt_nota_fiscal_transportadora_cidade->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_cidade'];
         $this->mgt_nota_fiscal_transportadora_estado->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_estado'];
         $this->mgt_nota_fiscal_transportadora_cep->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_transportadora_cep'];
         $this->mgt_nota_fiscal_qtde->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_qtde'];
         $this->mgt_nota_fiscal_especie->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_especie'];
         $this->mgt_nota_fiscal_marca->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_marca'];
         $this->mgt_nota_fiscal_vol_numero->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_vol_numero'];
         $this->mgt_nota_fiscal_peso_bruto->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_peso_bruto'];
         $this->mgt_nota_fiscal_peso_liquido->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_peso_liquido'];

         //*** Calculo dos Impostos ***
         $this->mgt_nota_fiscal_aliquota_icms->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_aliquota_icms'];
         $this->mgt_nota_fiscal_base_aliquota_icms_reduzida->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_base_aliquota_icms_reduzida'];
         $this->mgt_nota_fiscal_valor_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_valor_desconto'];

         $this->mgt_nota_fiscal_revenda->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_revenda'];
         $this->mgt_nota_fiscal_consumo->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_consumo'];
         $this->mgt_nota_fiscal_zerar_base_icms->Text = GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_zerar_base_icms'];
   ...
   function bt_fecharClick($sender, $params)
   {
      ...
      redirect('nf_historico_programada.php');
   }

   function bt_imprimirClick($sender, $params)
   {
      if(trim($this->mgt_nota_fiscal_natureza_operacao->Text) != '--- SELECIONE A NATUREZA DE OPERACAO ---')
      {
         if(trim($this->mgt_nota_fiscal_tipo_faturamento->Text) == 'Venda Programada')
         {
            $this->msg_confirmacao->Caption = '<center>A Impressora esta posicionada corretamente?</center>';
         }
         else
         {
            $this->msg_confirmacao->Caption = '<center>Verifique na impressora se a letra <b>DRAFT</b> esta ativada, se a opcao de <b>CONDENSADO</b> esta ativada e se a impressora esta <b>POSICIONADA</b> corretamente.<br>Todos itens acima estao corretos?</center>';
         }

         $this->confirmacao->Top = 275;
         $this->confirmacao->IsVisible = true;
      }
      else
      {
         $this->MSG_Erro->Caption = 'Nao e possivel imprimir uma Nota sem a Natureza de Operacao.';
      }
   }

   function nfhistoricoprogramadaexbJSLoad($sender, $params)
   {
...
global $nfhistoricoprogramadaexb;

//Creates the form
$nfhistoricoprogramadaexb = new nfhistoricoprogramadaexb($application);

//Read from resource file
$nfhistoricoprogramadaexb->loadResource(__FILE__);

//Shows the form
$nfhistoricoprogramadaexb->show();
