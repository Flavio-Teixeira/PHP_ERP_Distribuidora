<?php
<object class="relcobrancavencer" name="relcobrancavencer" baseclass="page">
  ...
  <property name="Name">relcobrancavencer</property>
  <property name="Width">755</property>
  <property name="OnCreate">relcobrancavencerCreate</property>
  <property name="jsOnLoad">relcobrancavencerJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE COBRANCA - A Vencer]]></property>
