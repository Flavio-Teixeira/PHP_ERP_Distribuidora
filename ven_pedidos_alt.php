...
//Class definition
class venpedidosalt extends Page
{
   ...
   var campo = document.venpedidosalt.mgt_faturar_produto_qtde;
   ...
   {
     document.venpedidosalt.bt_registrar.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_faturar_produto_qtde.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_faturar_produto_descricao.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_faturar_produto_referencia.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.venpedidosalt.hd_faturar_produto_numero.value = registros_faturar.getTableModel().getValue(8, registros_faturar.getFocusedRow());

      document.venpedidosalt.mgt_faturar_produto_codigo.value = registros_faturar.getTableModel().getValue(3, registros_faturar.getFocusedRow());
      document.venpedidosalt.mgt_faturar_produto_referencia.value = registros_faturar.getTableModel().getValue(4, registros_faturar.getFocusedRow());
      document.venpedidosalt.mgt_faturar_produto_descricao.value = registros_faturar.getTableModel().getValue(5, registros_faturar.getFocusedRow());
      document.venpedidosalt.mgt_faturar_produto_qtde.value = registros_faturar.getTableModel().getValue(2, registros_faturar.getFocusedRow());

      document.venpedidosalt.hd_faturar_produto_qtde_solicitada.value = registros_faturar.getTableModel().getValue(0, registros_faturar.getFocusedRow());
      document.venpedidosalt.hd_faturar_produto_qtde_faturado.value = registros_faturar.getTableModel().getValue(1, registros_faturar.getFocusedRow());
   ...
   public function gerar_faturamento()
   {
      ...
      while((GetConexaoPrincipal()->SQL_MGT_Pedidos_Produtos->EOF) != 1)
      {
         if(GetConexaoPrincipal()->SQL_MGT_Pedidos_Produtos->Fields['mgt_pedido_produto_quantidade_faturar'] > 0)
         {
            ...
            $Comando_SQL .= "'" . trim(((((GetConexaoPrincipal()->SQL_MGT_Pedidos_Produtos->Fields['mgt_pedido_produto_valor_unitario'] - ((GetConexaoPrincipal()->SQL_MGT_Pedidos_Produtos->Fields['mgt_pedido_produto_valor_unitario'] * $this->mgt_pedido_cliente_desconto->Text) / 100)) * GetConexaoPrincipal()->SQL_MGT_Pedidos_Produtos->Fields['mgt_pedido_produto_quantidade_faturar']) * GetConexaoPrincipal()->SQL_MGT_Pedidos_Produtos->Fields['mgt_pedido_produto_ipi']) / 100)) . "',";
            ...
            $Comando_SQL .= "'" . trim(GetConexaoPrincipal()->SQL_MGT_Produtos->Fields['mgt_produto_codigo_barras']) . "')";
      ...
      GetConexaoPrincipal()->SQL_MGT_Pedidos->SQL = $_SESSION['comando_sql_grid'];
   ...
   function bt_producaoClick($sender, $params)
   {
      ...
      else
      {
         ...
         {
            if((trim(GetConexaoPrincipal()->SQL_MGT_Pedidos->Fields['mgt_pedido_status']) == 'Aguardando') Or (trim(GetConexaoPrincipal()->SQL_MGT_Pedidos->Fields['mgt_pedido_status']) == 'Preparando') )
            {
            ...
            echo 'window.location="ven_pedidos.php";';
            echo '</script>';
         }
      }
   }
   ...
   var campo = document.venpedidosalt.mgt_alterar_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.venpedidosalt.mgt_alterar_produto_valor_total.value = (document.venpedidosalt.mgt_alterar_produto_qtde.value * document.venpedidosalt.mgt_alterar_produto_preco.value).toFixed(2);
   document.venpedidosalt.mgt_alterar_produto_valor_ipi.value   = ((document.venpedidosalt.mgt_alterar_produto_valor_total.value * document.venpedidosalt.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.bt_alterar_sim.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_alterar_produto_ipi.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_alterar_produto_unidade.focus();
     return false;
   }
   ...
   var campo = document.venpedidosalt.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_alterar_produto_lote.focus();
     return false;
   }
   ...
   var campo = document.venpedidosalt.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_alterar_produto_preco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_alterar_produto_qtde.focus();
     return false;
   }
   ...
   function bt_alterar_simClick($sender, $params)
   {
      if((trim($this->mgt_alterar_produto_codigo->Text) <> '') and (trim($this->mgt_alterar_produto_qtde->Text) <> '') and (trim($this->mgt_alterar_produto_qtde->Text) > 0))
      {
         ...
         $Comando_SQL .= "mgt_pedido_produto_codigo_barras = '" . trim($this->mgt_alterar_produto_codigo_barras->Text) . "' ";
         $Comando_SQL .= " where ";
   ...
   function registros_produtosJSRowChanged($sender, $params)
   {
      ...
      document.venpedidosalt.produto_remover_numero.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.venpedidosalt.produto_remover_numero_pedido.value = document.venpedidosalt.mgt_pedido_numero.value;
      document.venpedidosalt.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.venpedidosalt.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.venpedidosalt.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(11, registros_produtos.getFocusedRow());
      document.venpedidosalt.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(12, registros_produtos.getFocusedRow());
	  document.venpedidosalt.hd_alterar_produto_codigo_barras.value = registros_produtos.getTableModel().getValue(13, registros_produtos.getFocusedRow());
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_tipo_faturamento.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.venpedidosalt.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.venpedidosalt.mgt_produto_qtde.value        = '0';
      document.venpedidosalt.mgt_produto_valor_total.value = '0.00';
      document.venpedidosalt.mgt_produto_valor_ipi.value   = '0.00';
	  document.venpedidosalt.mgt_produto_codigo_barras.value = registros_produtos_busca.getTableModel().getValue(7, registros_produtos_busca.getFocusedRow());
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.bt_adicionar_produto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_produto_ipi.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_produto_unidade.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_produto_lote.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_produto_preco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_produto_qtde.focus();
     return false;
   }
   ...
   var campo = document.venpedidosalt.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.venpedidosalt.mgt_produto_valor_total.value = (document.venpedidosalt.mgt_produto_qtde.value * document.venpedidosalt.mgt_produto_preco.value).toFixed(2);
   document.venpedidosalt.mgt_produto_valor_ipi.value   = ((document.venpedidosalt.mgt_produto_valor_total.value * document.venpedidosalt.mgt_produto_ipi.value) / 100).toFixed(2);
   ...
   var campo = document.venpedidosalt.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.venpedidosalt.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.bt_busca_produto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.opcao_busca_produto.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.venpedidosalt.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.venpedidosalt.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.venpedidosalt.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.venpedidosalt.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.venpedidosalt.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.venpedidosalt.MSG_Alerta.value = '';
      }

      document.venpedidosalt.hd_pedido_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.venpedidosalt.hd_pedido_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.venpedidosalt.hd_pedido_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.venpedidosalt.hd_pedido_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.venpedidosalt.hd_pedido_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.venpedidosalt.hd_pedido_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.venpedidosalt.hd_pedido_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
      <?php
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.bt_buscar.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.opcao_busca.focus();
     return false;
   }
   ...
   var campo = document.venpedidosalt.mgt_pedido_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venpedidosalt.mgt_pedido_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Pedido ***
      if(document.venpedidosalt.mgt_pedido_cliente_desconto.value == '')
      {
         document.venpedidosalt.mgt_pedido_cliente_desconto.value = 0;
      }
      document.venpedidosalt.mgt_pedido_valor_desconto.value = ((parseFloat(document.venpedidosalt.mgt_pedido_valor_pedido.value) * parseFloat(document.venpedidosalt.mgt_pedido_cliente_desconto.value)) / 100).toFixed(2);
      document.venpedidosalt.mgt_pedido_valor_total.value = (parseFloat(document.venpedidosalt.mgt_pedido_valor_pedido.value) - parseFloat(document.venpedidosalt.mgt_pedido_valor_desconto.value) + parseFloat(document.venpedidosalt.mgt_pedido_valor_frete.value) + parseFloat(document.venpedidosalt.mgt_pedido_valor_ipi.value)).toFixed(2);
   ...
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venpedidosalt.mgt_pedido_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_valor_frete.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_12.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_11.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_10.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_9.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_8.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_7.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_6.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_5.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_4.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_3.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_condicao_pgto_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.bt_alterar_pedido.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_observacao.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_ordem_compra.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venpedidosalt.mgt_pedido_cliente_transportadora.focus();
     return false;
   }
   ...
   function venpedidosaltCreate($sender, $params)
   {
   ...
   function venpedidosaltJSLoad($sender, $params)
   {
...
global $venpedidosalt;

//Creates the form
$venpedidosalt = new venpedidosalt($application);

//Read from resource file
$venpedidosalt->loadResource(__FILE__);
