<?php
<object class="relfaturamentoperiodo" name="relfaturamentoperiodo" baseclass="page">
  ...
  <property name="Name">relfaturamentoperiodo</property>
  <property name="Width">755</property>
  <property name="OnCreate">relfaturamentoperiodoCreate</property>
  <property name="jsOnLoad">relfaturamentoperiodoJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE FATURAMENTO - Faturamento por Periodo]]></property>
