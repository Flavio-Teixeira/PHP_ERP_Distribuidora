...
*/
        ...
        */
        class FormValidator extends Component
        {
            ...
            * In RadPHP XE, there is a property editor you can use to setup
            ...
            */
            ...
            function dumpHeaderCode()
            {
                ...
                {
                ?>
                <script language="javascript" src="<?php echo RPCL_HTTP_PATH; ?>/jsval/jsval.js"></script>
                <?php
                }
?>
...
{
        form=findObj('<?php echo $this->owner->Name; ?>');
