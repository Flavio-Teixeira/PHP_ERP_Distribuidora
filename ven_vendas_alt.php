...
//Class definition
class venvendasalt extends Page
{
   ...
   function bt_sim_exclusaoClick($sender, $params)
   {
      if(trim($this->mgt_operacao_cadastro_motivo->text) <> '')
      {
         ...
         //*** Atualiza o Grid dos Faturamentos ***
         /*
...
?>
   ...
   var campo = document.venvendasalt.mgt_alterar_produto_ipi;
   ...
   document.venvendasalt.mgt_alterar_produto_valor_total.value = (document.venvendasalt.mgt_alterar_produto_qtde.value * document.venvendasalt.mgt_alterar_produto_preco.value).toFixed(2);
   document.venvendasalt.mgt_alterar_produto_valor_ipi.value   = ((document.venvendasalt.mgt_alterar_produto_valor_total.value * document.venvendasalt.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   {
     document.venvendasalt.bt_alterar_sim.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_alterar_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_alterar_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venvendasalt.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_alterar_produto_lote.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venvendasalt.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_alterar_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_alterar_produto_qtde.focus();
     return false;
   }
...
?>
      ...
      document.venvendasalt.produto_remover_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venvendasalt.produto_remover_numero_faturamento.value = document.venvendasalt.mgt_faturamento_numero.value;
      document.venvendasalt.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venvendasalt.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.venvendasalt.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.venvendasalt.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_tipo_faturamento.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venvendasalt.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.venvendasalt.mgt_produto_qtde.value        = '0';
      document.venvendasalt.mgt_produto_valor_total.value = '0.00';
      document.venvendasalt.mgt_produto_valor_ipi.value   = '0.00';
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.bt_adicionar_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_produto_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_produto_qtde.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venvendasalt.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.venvendasalt.mgt_produto_valor_total.value = (document.venvendasalt.mgt_produto_qtde.value * document.venvendasalt.mgt_produto_preco.value).toFixed(2);
   document.venvendasalt.mgt_produto_valor_ipi.value   = ((document.venvendasalt.mgt_produto_valor_total.value * document.venvendasalt.mgt_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   var campo = document.venvendasalt.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.venvendasalt.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.bt_busca_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.opcao_busca_produto.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venvendasalt.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.venvendasalt.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.venvendasalt.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.venvendasalt.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.venvendasalt.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.venvendasalt.MSG_Alerta.value = '';
      }

      document.venvendasalt.hd_faturamento_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.venvendasalt.hd_faturamento_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.venvendasalt.hd_faturamento_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.venvendasalt.hd_faturamento_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.venvendasalt.hd_faturamento_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.venvendasalt.hd_faturamento_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.venvendasalt.hd_faturamento_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
<?php
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venvendasalt.mgt_faturamento_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Faturamento ***
      if(document.venvendasalt.mgt_faturamento_cliente_desconto.value == '')
      {
         document.venvendasalt.mgt_faturamento_cliente_desconto.value = 0;
      }
      document.venvendasalt.mgt_faturamento_valor_desconto.value = ((parseFloat(document.venvendasalt.mgt_faturamento_valor_pedido.value) * parseFloat(document.venvendasalt.mgt_faturamento_cliente_desconto.value)) / 100).toFixed(2);
      document.venvendasalt.mgt_faturamento_valor_total.value = (parseFloat(document.venvendasalt.mgt_faturamento_valor_pedido.value) - parseFloat(document.venvendasalt.mgt_faturamento_valor_desconto.value) + parseFloat(document.venvendasalt.mgt_faturamento_valor_frete.value) + parseFloat(document.venvendasalt.mgt_faturamento_valor_ipi.value)).toFixed(2);
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venvendasalt.mgt_faturamento_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.bt_alterar_faturamento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_observacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venvendasalt.mgt_faturamento_cliente_transportadora.focus();
     return false;
   }
...
<?php
   ...
   function venvendasaltCreate($sender, $params)
   {
      ...
      $Comando_SQL = "select *,date_format(mgt_faturamento_data, '%d/%m/%Y') AS mgt_faturamento_data,date_format(mgt_faturamento_data_entrega, '%d/%m/%Y') AS mgt_faturamento_data_entrega, IF(mgt_faturamento_status = 'Preparando','#','') AS mgt_faturamento_status_1, IF(mgt_faturamento_status = 'Faturado','#','') AS mgt_faturamento_status_2, IF(mgt_faturamento_status = 'Aguardando','#','') AS mgt_faturamento_status_3 from mgt_faturamentos where mgt_faturamento_numero = '" . trim($mgt_faturamento_numero) . "' order by mgt_faturamento_numero";
      ...
      $this->mgt_faturamento_valor_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_valor_desconto'];
   ...
   function venvendasaltJSLoad($sender, $params)
   {
...
//Creates the form
$venvendasalt = new venvendasalt($application);

//Read from resource file
$venvendasalt->loadResource(__FILE__);
