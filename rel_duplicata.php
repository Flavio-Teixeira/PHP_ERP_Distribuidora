...
//Class definition
class relduplicata extends Page
{
   ...
   var campo = document.relduplicata.mgt_data_final
   ...
   var campo = document.relduplicata.mgt_data_inicial
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   {
     document.relduplicata.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relduplicata.mgt_data_final.focus();
     return false;
   }
...
<?php
   ...
   function relduplicataJSLoad($sender, $params)
   {
...
//Creates the form
$relduplicata = new relduplicata($application);

//Read from resource file
$relduplicata->loadResource(__FILE__);
