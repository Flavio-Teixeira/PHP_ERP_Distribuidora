    ...
    function defaultDivWrap() { return 1; }
        ...
        */
        ...
        function dumpJavascript()
        {
                ...
                if ($this->_enabled == 1 && $this->_popupmenu != null && !$this->inheritsFrom("QWidget") && !$this->inheritsFrom("QControl"))
                {
...
//                        $hiddenfield = ($this->owner != null) ? "document.forms[0].$hiddenfield" : "null";
        ...
        */
        ...
        function defaultCursor() { return crDefault; }
