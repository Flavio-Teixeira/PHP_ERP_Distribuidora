...
//Class definition
class comcotacoesalt extends Page
{
   ...
   function bt_imprimirClick($sender, $params)
   {
      ...
      {
         $this->MSG_Erro->Caption = "O Numero da Cotacao deve ser informado.";
      }
      else
      {
         $Comando_SQL = "select *,date_format(mgt_cotacao_data, '%d/%m/%Y') AS mgt_cotacao_data,date_format(mgt_cotacao_data_entrega, '%d/%m/%Y') AS mgt_cotacao_data_entrega, IF(mgt_cotacao_status = 'Preparando','#','') AS mgt_cotacao_status_1, IF(mgt_cotacao_status = 'Faturado','#','') AS mgt_cotacao_status_2, IF(mgt_cotacao_status = 'Semi-Faturado','#','') AS mgt_cotacao_status_3, IF(mgt_cotacao_status = 'Aguardando','#','') AS mgt_cotacao_status_4, IF(mgt_cotacao_status = 'Producao','#','') AS mgt_cotacao_status_5 from mgt_cotacoes where mgt_cotacao_numero = '" . trim($this->mgt_pedido_numero->Text) . "' and mgt_cotacao_status <> 'Faturado' order by mgt_cotacao_numero";
         ...
         {
            $this->MSG_Erro->Caption = "A Cotacao Nao foi encontrada.";
         }
         else
         {
...
<?php
   ...
   function bt_gerar_simClick($sender, $params)
   {
      ...
      $Comando_SQL .= "mgt_ordem_cliente_numero, ";
      $Comando_SQL .= "mgt_ordem_cliente_codigo, ";
      $Comando_SQL .= "mgt_ordem_cliente_nome, ";
      $Comando_SQL .= "mgt_ordem_cliente_desconto, ";
      $Comando_SQL .= "mgt_ordem_data, ";
      $Comando_SQL .= "mgt_ordem_data_entrega, ";
      $Comando_SQL .= "mgt_ordem_orcamento, ";
      $Comando_SQL .= "mgt_ordem_observacao, ";
      $Comando_SQL .= "mgt_ordem_valor_desconto, ";
      $Comando_SQL .= "mgt_ordem_valor_ordem, ";
      $Comando_SQL .= "mgt_ordem_valor_frete, ";
      $Comando_SQL .= "mgt_ordem_valor_ipi, ";
      $Comando_SQL .= "mgt_ordem_valor_total, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_1, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_2, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_3, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_4, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_5, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_6, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_7, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_8, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_9, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_10, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_11, ";
      $Comando_SQL .= "mgt_ordem_cliente_condicao_pgto_12, ";
      $Comando_SQL .= "mgt_ordem_status, ";
      $Comando_SQL .= "mgt_ordem_funcionario, ";
      $Comando_SQL .= "mgt_ordem_vendedor) ";
      $Comando_SQL .= "values(";
      ...
      $Comando_SQL = "select * from mgt_ordens order by mgt_ordem_numero desc";
      ...
      $nro_ordem = GetConexaoPrincipal()->SQL_MGT_Ordens->Fields['mgt_ordem_numero'];

      //*** Incluir os produtos na Ordem

      $Comando_SQL = "select * from mgt_cotacoes_produtos where mgt_cotacao_produto_numero_cotacao = '" . trim($this->mgt_pedido_numero->Text) . "'";
      ...
      if((GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->EOF) != 1)
      {
         while((GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->EOF) != 1)
         {
            ...
            $Comando_SQL .= "values(";
            $Comando_SQL .= "'" . $nro_ordem . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_quantidade'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_codigo'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_descricao'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_valor_unitario'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_valor_total'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_valor_ipi'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_lote'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_referencia'] . "',";
            $Comando_SQL .= "'" . "0" . "',";
            $Comando_SQL .= "'" . " " . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_unidade'] . "',";
            $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Cotacoes_Produtos->Fields['mgt_cotacao_produto_ipi'] . "')";
      ...
      $Comando_SQL .= "mgt_cotacao_status = 'Comprada', ";
      $Comando_SQL .= "mgt_cotacao_ordem = '" . $this->mgt_pedido_ordem->Text . $nro_ordem . " | " . "' ";
   ...
   function bt_sim_exclusaoClick($sender, $params)
   {
      if(trim($this->mgt_operacao_cadastro_motivo->text) <> '')
      {
         ...
         $Comando_SQL = "delete from mgt_cotacoes ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_cotacao_numero='" . trim($this->mgt_pedido_numero->Text) . "'";
         ...
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_cotacao_produto_numero_cotacao='" . trim($this->mgt_pedido_numero->Text) . "'";
...
?>
   ...
   //*** Obtem o Registro Clicado ***
      ...
      document.comcotacoesalt.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
      document.comcotacoesalt.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
      document.comcotacoesalt.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());

      document.comcotacoesalt.hd_faturamento_cliente_desconto.value = '0';
      document.comcotacoesalt.hd_faturamento_cliente_condicao_pgto_1.value = '0';
      document.comcotacoesalt.hd_faturamento_cliente_condicao_pgto_2.value = '0';
      document.comcotacoesalt.hd_faturamento_cliente_condicao_pgto_3.value = '0';
      document.comcotacoesalt.hd_faturamento_cliente_condicao_pgto_4.value = '0';
      document.comcotacoesalt.hd_faturamento_cliente_transportadora.value = '0';
      document.comcotacoesalt.hd_faturamento_cliente_observacao.value = '';
<?php
...
?>
   ...
   {
     document.comcotacoesalt.bt_buscar_fornecedor.focus();
     return false;
   }
<?php
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.opcao_busca_fornecedor.focus();
     return false;
   }
<?php
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_orcamento.focus();
     return false;
   }
<?php
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_vendedor.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_alterar_produto_ipi;
   ...
   document.comcotacoesalt.mgt_alterar_produto_valor_total.value = (document.comcotacoesalt.mgt_alterar_produto_qtde.value * document.comcotacoesalt.mgt_alterar_produto_preco.value).toFixed(2);
   document.comcotacoesalt.mgt_alterar_produto_valor_ipi.value   = ((document.comcotacoesalt.mgt_alterar_produto_valor_total.value * document.comcotacoesalt.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.bt_alterar_sim.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_alterar_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_alterar_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_alterar_produto_lote.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_alterar_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_alterar_produto_qtde.focus();
     return false;
   }
...
?>
      ...
      document.comcotacoesalt.produto_remover_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comcotacoesalt.produto_remover_numero_pedido.value = document.comcotacoesalt.mgt_pedido_numero.value;
      document.comcotacoesalt.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comcotacoesalt.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.comcotacoesalt.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.comcotacoesalt.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_status.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.comcotacoesalt.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.comcotacoesalt.mgt_produto_qtde.value        = '0';
      document.comcotacoesalt.mgt_produto_valor_total.value = '0.00';
      document.comcotacoesalt.mgt_produto_valor_ipi.value   = '0.00';
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.bt_adicionar_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_produto_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_produto_qtde.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.comcotacoesalt.mgt_produto_valor_total.value = (document.comcotacoesalt.mgt_produto_qtde.value * document.comcotacoesalt.mgt_produto_preco.value).toFixed(2);
   document.comcotacoesalt.mgt_produto_valor_ipi.value   = ((document.comcotacoesalt.mgt_produto_valor_total.value * document.comcotacoesalt.mgt_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.bt_busca_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.opcao_busca_produto.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.comcotacoesalt.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.comcotacoesalt.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.comcotacoesalt.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.comcotacoesalt.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.comcotacoesalt.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.comcotacoesalt.MSG_Alerta.value = '';
      }

      document.comcotacoesalt.hd_pedido_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.comcotacoesalt.hd_pedido_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.comcotacoesalt.hd_pedido_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.comcotacoesalt.hd_pedido_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.comcotacoesalt.hd_pedido_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.comcotacoesalt.hd_pedido_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.comcotacoesalt.hd_pedido_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
<?php
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comcotacoesalt.mgt_pedido_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Pedido ***
      if(document.comcotacoesalt.mgt_pedido_cliente_desconto.value == '')
      {
         document.comcotacoesalt.mgt_pedido_cliente_desconto.value = 0;
      }
      document.comcotacoesalt.mgt_pedido_valor_desconto.value = ((parseFloat(document.comcotacoesalt.mgt_pedido_valor_pedido.value) * parseFloat(document.comcotacoesalt.mgt_pedido_cliente_desconto.value)) / 100).toFixed(2);
      document.comcotacoesalt.mgt_pedido_valor_total.value = (parseFloat(document.comcotacoesalt.mgt_pedido_valor_pedido.value) - parseFloat(document.comcotacoesalt.mgt_pedido_valor_desconto.value) + parseFloat(document.comcotacoesalt.mgt_pedido_valor_frete.value) + parseFloat(document.comcotacoesalt.mgt_pedido_valor_ipi.value)).toFixed(2);
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comcotacoesalt.mgt_pedido_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.bt_incluir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_observacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_funcionario.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comcotacoesalt.mgt_pedido_cliente_tipo_faturamento.focus();
     return false;
   }
...
<?php
   ...
   function comcotacoesaltCreate($sender, $params)
   {
      ...
      $Comando_SQL = "select *,date_format(mgt_cotacao_data, '%d/%m/%Y') AS mgt_cotacao_data,date_format(mgt_cotacao_data_entrega, '%d/%m/%Y') AS mgt_cotacao_data_entrega, IF(mgt_cotacao_status = 'Preparando','#','') AS mgt_cotacao_status_1, IF(mgt_cotacao_status = 'Faturado','#','') AS mgt_cotacao_status_2, IF(mgt_cotacao_status = 'Semi-Faturado','#','') AS mgt_cotacao_status_3, IF(mgt_cotacao_status = 'Aguardando','#','') AS mgt_cotacao_status_4, IF(mgt_cotacao_status = 'Producao','#','') AS mgt_cotacao_status_5 from mgt_cotacoes where mgt_cotacao_numero = '" . trim($mgt_pedido_numero) . "' and mgt_cotacao_status <> 'Faturado' order by mgt_cotacao_numero";
      ...
      $this->mgt_pedido_cliente_numero->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_numero'];
      $this->mgt_pedido_cliente_codigo->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_codigo'];
      $this->mgt_pedido_cliente_nome->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_nome'];

      $this->mgt_pedido_cliente_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_desconto'];
      $this->mgt_pedido_data->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_data'];
      $this->mgt_pedido_data_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_data_entrega'];
      $this->mgt_pedido_cliente_condicao_pgto_1->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_1'];
      $this->mgt_pedido_cliente_condicao_pgto_2->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_2'];
      $this->mgt_pedido_cliente_condicao_pgto_3->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_3'];
      $this->mgt_pedido_cliente_condicao_pgto_4->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_4'];
      $this->mgt_pedido_cliente_condicao_pgto_5->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_5'];
      $this->mgt_pedido_cliente_condicao_pgto_6->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_6'];
      $this->mgt_pedido_cliente_condicao_pgto_7->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_7'];
      $this->mgt_pedido_cliente_condicao_pgto_8->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_8'];
      $this->mgt_pedido_cliente_condicao_pgto_9->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_9'];
      $this->mgt_pedido_cliente_condicao_pgto_10->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_10'];
      $this->mgt_pedido_cliente_condicao_pgto_11->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_11'];
      $this->mgt_pedido_cliente_condicao_pgto_12->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_cliente_condicao_pgto_12'];
      $this->mgt_pedido_cliente_observacao->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_observacao'];
      $this->mgt_pedido_orcamento->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_orcamento'];

      $this->mgt_pedido_valor_pedido->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_valor_cotacao'];
      $this->mgt_pedido_valor_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_valor_desconto'];
      $this->mgt_pedido_valor_frete->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_valor_frete'];
      $this->mgt_pedido_valor_ipi->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_valor_ipi'];
      $this->mgt_pedido_valor_total->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_valor_total'];

      $this->mgt_pedido_status->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_status'];
      $this->mgt_pedido_funcionario->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_funcionario'];
      $this->mgt_pedido_vendedor->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_vendedor'];

      $this->mgt_pedido_ordem->Text = GetConexaoPrincipal()->SQL_MGT_Cotacoes->Fields['mgt_cotacao_ordem'];
   ...
   function comcotacoesaltJSLoad($sender, $params)
   {
...
global $comcotacoesalt;

//Creates the form
$comcotacoesalt = new comcotacoesalt($application);

//Read from resource file
$comcotacoesalt->loadResource(__FILE__);
