...
class Pager extends Control
{
    ...
    */
    ...
    function setDesignTotalRecords($value) { if ($value<=0) $value=1; $this->_designtotalrecords=$value; }
    ...
    */
    ...
    function setRecordsPerPage($value) { if ($value<=0) $value=1; $this->_recordsperpage=$value; }
    ...
    * from rpcl/css folder, if you want to use your css file, just use
...
<?php
	...
	{
?>
@import "<?php echo RPCL_HTTP_PATH; ?>/css/<?php echo $this->_cssfile; ?>";
<?php
	}
?>
