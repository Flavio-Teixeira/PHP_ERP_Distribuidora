<?php
<object class="relestoquefamilias" name="relestoquefamilias" baseclass="page">
  ...
  <property name="Name">relestoquefamilias</property>
  <property name="Width">755</property>
  <property name="OnCreate">relestoquefamiliasCreate</property>
  <property name="jsOnLoad">relestoquefamiliasJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE ESTOQUE DE PRODUTOS - Familias]]></property>
  ...
  <object class="GroupBox" name="GroupBox1" >
    ...
    <object class="Label" name="Label4" >
      <property name="Caption"><![CDATA[Familias de Produtos]]></property>
      <property name="Height">13</property>
    ...
    <object class="ComboBox" name="opcao_estoque" >
      <property name="Height">18</property>
      <property name="ItemIndex">0</property>
      <property name="Items">a:0:{}</property>
      <property name="Left">14</property>
      <property name="Name">opcao_estoque</property>
      <property name="Top">41</property>
      <property name="Width">584</property>
      <property name="OnChange">opcao_estoqueChange</property>
    </object>
  </object>
  ...
  <object class="Label" name="Label1" >
    <property name="Caption">Resultado de Estoque Obtido:</property>
    <property name="Height">13</property>
    <property name="Left">8</property>
