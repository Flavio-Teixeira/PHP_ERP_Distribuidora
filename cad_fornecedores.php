...
//Class definition
class cadfornecedores extends Page
{
   public $Label5 = null;
...
?>
   ...
   {
     document.cadfornecedores.bt_cadastro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.cadfornecedores.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.cadfornecedores.opcao_busca.focus();
     return false;
   }
   ...
   function bt_cadastroClick($sender, $params)
   {
      ...
      {
         $Comando_SQL = "select * from mgt_fornecedores where mgt_fornecedor_numero = '" . $this->abrir_cadastro->Text . "' order by mgt_fornecedor_numero";
         ...
         {
            redirect('cad_fornecedores_alt.php?mgt_fornecedor_numero=' . $this->abrir_cadastro->Text );
         }
      }
   }
...
?>
   ...
   document.cadfornecedores.abrir_cadastro.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
   ...
   {
         redirect('cad_fornecedores_inc.php');
   }
   ...
   function cadfornecedoresCreate($sender, $params)
   {
   ...
   function cadfornecedoresJSLoad($sender, $params)
   {
...
global $cadfornecedores;

//Creates the form
$cadfornecedores = new cadfornecedores($application);

//Read from resource file
$cadfornecedores->loadResource(__FILE__);
