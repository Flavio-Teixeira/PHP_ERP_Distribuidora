...
//Definicao de classe
class comrequisicoesimp extends Page
{
   ...
   function comrequisicoesimpCreate($sender, $params)
   {
      ...
      $this->relatorio_titulo->Caption = 'Requisicao - Nro.: ' . trim($mgt_pedido_numero);
      $this->Caption = 'Requisicao_' . trim($mgt_pedido_numero);
   }
   function comrequisicoesimpJSLoad($sender, $params)
   {
...
global $comrequisicoesimp;

//Cria o formulario
$comrequisicoesimp = new comrequisicoesimp($application);

//Ler do arquivo de recursos
$comrequisicoesimp->loadResource(__FILE__);

//Mostrar o formulario
$comrequisicoesimp->show();
