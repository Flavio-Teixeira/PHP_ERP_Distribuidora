<?php
<object class="cadncmstabelasalt" name="cadncmstabelasalt" baseclass="page">
  ...
  <property name="Name">cadncmstabelasalt</property>
  <property name="Width">755</property>
  <property name="OnCreate">cadncmstabelasaltCreate</property>
  <property name="jsOnLoad">cadncmstabelasaltJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[CADASTRO - Tabela Geral de NCMs - Alteracao / Consulta]]></property>
