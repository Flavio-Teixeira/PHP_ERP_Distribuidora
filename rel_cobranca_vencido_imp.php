...
//Definicao de classe
class relcobrancavencidoimp extends Page
{
   ...
   function relcobrancavencidoimpCreate($sender, $params)
   {
            ...
            while((GetConexaoPrincipal()->SQL_MGT_Notas_Fiscais->EOF) != 1)
            {
               ...
               if(trim($dt_vcto_1) != '')
               {
                  ...
                  )
                  {
                     ...
                     $Comando_SQL .= "'" . "(" . GetConexaoPrincipal()->SQL_MGT_Notas_Fiscais->Fields['mgt_nota_fiscal_ddd'] . ")" . GetConexaoPrincipal()->SQL_MGT_Notas_Fiscais->Fields['mgt_nota_fiscal_fone_cobranca'] . "')";
            ...
            while((GetConexaoPrincipal()->SQL_MGT_Programadas->EOF) != 1)
            {
               ...
               if(trim($dt_vcto_1) != '')
               {
                  ...
                  )
                  {
                     ...
                     $Comando_SQL .= "'" . GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_email'] . "',";
                     $Comando_SQL .= "'" . "(" . GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_ddd'] . ")" . GetConexaoPrincipal()->SQL_MGT_Programadas->Fields['mgt_programada_fone_cobranca'] . "')";
...
global $relcobrancavencidoimp;

//Cria o formulario
$relcobrancavencidoimp = new relcobrancavencidoimp($application);

//Ler do arquivo de recursos
$relcobrancavencidoimp->loadResource(__FILE__);

//Mostrar o formulario
$relcobrancavencidoimp->show();
