...
//Class definition
class comordensinc extends Page
{
    public $Label29 = null;
   ...
   function mgt_ordem_cliente_descontoJSFocus($sender, $params)
   {
      ?>
   ...
   var campo = document.comordensinc.mgt_alterar_produto_ipi;
   ...
   document.comordensinc.mgt_alterar_produto_valor_total.value = (document.comordensinc.mgt_alterar_produto_qtde.value * document.comordensinc.mgt_alterar_produto_preco.value).toFixed(2);
   document.comordensinc.mgt_alterar_produto_valor_ipi.value   = ((document.comordensinc.mgt_alterar_produto_valor_total.value * document.comordensinc.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
   ...
   {
     document.comordensinc.bt_alterar_sim.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_alterar_produto_ipi.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_alterar_produto_unidade.focus();
     return false;
   }
   ...
   var campo = document.comordensinc.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_alterar_produto_lote.focus();
     return false;
   }
   ...
   var campo = document.comordensinc.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_alterar_produto_preco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_alterar_produto_qtde.focus();
     return false;
   }
   ...
   function registros_produtosJSRowChanged($sender, $params)
   {
      ...
      document.comordensinc.produto_remover_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comordensinc.produto_remover_numero_pedido.value = document.comordensinc.mgt_ordem_numero.value;
      document.comordensinc.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comordensinc.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.comordensinc.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.comordensinc.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_data_entrega.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.comordensinc.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.comordensinc.mgt_produto_qtde.value        = '0';
      document.comordensinc.mgt_produto_valor_total.value = '0.00';
      document.comordensinc.mgt_produto_valor_ipi.value   = '0.00';
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.bt_adicionar_produto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_produto_ipi.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_produto_unidade.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_produto_lote.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_produto_preco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_produto_qtde.focus();
     return false;
   }
   ...
   var campo = document.comordensinc.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.comordensinc.mgt_produto_valor_total.value = (document.comordensinc.mgt_produto_qtde.value * document.comordensinc.mgt_produto_preco.value).toFixed(2);
   document.comordensinc.mgt_produto_valor_ipi.value   = ((document.comordensinc.mgt_produto_valor_total.value * document.comordensinc.mgt_produto_ipi.value) / 100).toFixed(2);
   ...
   var campo = document.comordensinc.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comordensinc.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.bt_busca_produto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.opcao_busca_produto.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comordensinc.mgt_ordem_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Ordem de Compra ***
      if(document.comordensinc.mgt_ordem_cliente_desconto.value == '')
      {
         document.comordensinc.mgt_ordem_cliente_desconto.value = 0;
      }
      document.comordensinc.mgt_ordem_valor_desconto.value = ((parseFloat(document.comordensinc.mgt_ordem_valor_pedido.value) * parseFloat(document.comordensinc.mgt_ordem_cliente_desconto.value)) / 100).toFixed(2);
      document.comordensinc.mgt_ordem_valor_total.value = (parseFloat(document.comordensinc.mgt_ordem_valor_pedido.value) - parseFloat(document.comordensinc.mgt_ordem_valor_desconto.value) + parseFloat(document.comordensinc.mgt_ordem_valor_frete.value) + parseFloat(document.comordensinc.mgt_ordem_valor_ipi.value)).toFixed(2);
   ...
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comordensinc.mgt_ordem_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comordensinc.mgt_ordem_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_valor_frete.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_12.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_11.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_10.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_9.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_8.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_7.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_6.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_5.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_4.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_3.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_condicao_pgto_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.bt_incluir.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_cliente_observacao.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comordensinc.mgt_ordem_orcamento.focus();
     return false;
   }
   ...
   function comordensincCreate($sender, $params)
   {
      ...
      //*** Carrega os Produtos do Ordem de Compra ***
      ...
      $this->mgt_ordem_data->Text = date("d/m/Y", time());
   }
   ...
   function bt_incluirClick($sender, $params)
   {
      ...
      else
      {
         ...
         $Comando_SQL .= "mgt_ordem_cliente_tipo_faturamento = 'Nota Fiscal',";
         $Comando_SQL .= "mgt_ordem_cliente_transportadora = '0',";
         ...
         $Comando_SQL .= "mgt_ordem_status = 'Aguardando', ";
   ...
   function comordensincJSLoad($sender, $params)
   {
   ...
   function dados_busca_fornecedorJSKeyPress($sender, $params)
   {
      ?>
        ...
        if((event.keyCode == 9) || (event.keyCode == 13) )
        {
          document.comordensinc.opcao_busca_fornecedor.focus();
          return false;
        }
   ...
   function opcao_busca_fornecedorJSKeyPress($sender, $params)
   {
      ?>
        ...
        if((event.keyCode == 9) || (event.keyCode == 13) )
        {
          document.comordensinc.bt_buscar_fornecedor.focus();
          return false;
        }
   ...
   function registros_fornecedoresJSRowChanged($sender, $params)
   {
      ?>
        ...
        document.comordensinc.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
        document.comordensinc.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
        document.comordensinc.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());

        document.comordensinc.hd_faturamento_cliente_desconto.value = '0';
        document.comordensinc.hd_faturamento_cliente_condicao_pgto_1.value = '0';
        document.comordensinc.hd_faturamento_cliente_condicao_pgto_2.value = '0';
        document.comordensinc.hd_faturamento_cliente_condicao_pgto_3.value = '0';
        document.comordensinc.hd_faturamento_cliente_condicao_pgto_4.value = '0';
        document.comordensinc.hd_faturamento_cliente_transportadora.value = '0';
        document.comordensinc.hd_faturamento_cliente_observacao.value = '';
    ...
    function mgt_ordem_funcionarioJSKeyPress($sender, $params)
    {
        ...
        if((event.keyCode == 9) || (event.keyCode == 13) )
        {
          document.comordensinc.mgt_ordem_vendedor.focus();
          return false;
        }
...
//Creates the form
$comordensinc = new comordensinc($application);

//Read from resource file
$comordensinc->loadResource(__FILE__);
