<?php
<object class="cadassistentesalt" name="cadassistentesalt" baseclass="page">
  ...
  <property name="Name">cadassistentesalt</property>
  <property name="Width">755</property>
  <property name="OnCreate">cadassistentesaltCreate</property>
  <property name="jsOnLoad">cadassistentesaltJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[CADASTRO - Assistentes - Alteracao / Consulta]]></property>
  ...
  <object class="GroupBox" name="GroupBox3" >
    ...
    <object class="Edit" name="mgt_assistente_codigo" >
      <property name="Color">#EBE9ED</property>
      <property name="Height">21</property>
      <property name="Left">94</property>
      <property name="MaxLength">3</property>
      <property name="Name">mgt_assistente_codigo</property>
      <property name="ParentColor">0</property>
      <property name="ReadOnly">1</property>
      <property name="TabOrder">1</property>
      <property name="Top">21</property>
      <property name="Width">33</property>
      <property name="jsOnKeyPress">mgt_assistente_codigoJSKeyPress</property>
    </object>
    ...
    <object class="GroupBox" name="GroupBox5" >
      ...
      <object class="GroupBox" name="GroupBox6" >
        ...
        <object class="RadioGroup" name="mgt_assistente_icms" >
          ...
          <property name="jsOnKeyPress">mgt_assistente_icmsJSKeyPress</property>
        </object>
      </object>
      <object class="GroupBox" name="GroupBox7" >
        ...
        <object class="RadioGroup" name="mgt_assistente_relatorio" >
          ...
          <property name="jsOnKeyPress">mgt_assistente_relatorioJSKeyPress</property>
        </object>
      </object>
