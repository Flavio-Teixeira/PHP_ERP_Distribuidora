...
//Class definition
class venservicosalt extends Page
{
   ...
   {
      $this->confirma_exclusao->Top = 1725;
   ...
   function bt_sim_exclusaoClick($sender, $params)
   {
      if(trim($this->mgt_operacao_cadastro_motivo->text) <> '')
      {
         ...
         $Comando_SQL = "delete from mgt_faturamentos_srv ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_faturamento_srv_numero='" . trim($this->mgt_faturamento_numero->Text) . "'";
         ...
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_faturamento_produto_srv_numero_pedido='" . trim($this->mgt_faturamento_numero->Text) . "'";
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.venservicosalt.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
      document.venservicosalt.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
      document.venservicosalt.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());

      document.venservicosalt.hd_faturamento_cliente_desconto.value = '0';
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_1.value = '0';
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_2.value = '0';
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_3.value = '0';
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_4.value = '0';
      document.venservicosalt.hd_faturamento_cliente_transportadora.value = '0';
      document.venservicosalt.hd_faturamento_cliente_observacao.value = '';
   ...
   {
     document.venservicosalt.bt_buscar_fornecedor.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.opcao_busca_fornecedor.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venservicosalt.mgt_alterar_produto_preco;
   ...
   document.venservicosalt.mgt_alterar_produto_valor_total.value = (document.venservicosalt.mgt_alterar_produto_qtde.value * document.venservicosalt.mgt_alterar_produto_preco.value).toFixed(2);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.bt_alterar_sim.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venservicosalt.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_alterar_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_alterar_produto_qtde.focus();
     return false;
   }
...
?>
      ...
      document.venservicosalt.produto_remover_numero.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.venservicosalt.produto_remover_numero_faturamento.value = document.venservicosalt.mgt_faturamento_numero.value;
      document.venservicosalt.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venservicosalt.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.venservicosalt.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.venservicosalt.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venservicosalt.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.venservicosalt.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.venservicosalt.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.venservicosalt.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_tipo_faturamento.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venservicosalt.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.venservicosalt.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.venservicosalt.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.venservicosalt.mgt_produto_qtde.value        = '0';
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.bt_adicionar_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_produto_qtde.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venservicosalt.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.venservicosalt.mgt_produto_valor_total.value = (document.venservicosalt.mgt_produto_qtde.value * document.venservicosalt.mgt_produto_preco.value).toFixed(2);
...
?>
   ...
   var campo = document.venservicosalt.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.bt_busca_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.opcao_busca_produto.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venservicosalt.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.venservicosalt.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.venservicosalt.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.venservicosalt.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.venservicosalt.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.venservicosalt.MSG_Alerta.value = '';
      }

      document.venservicosalt.hd_faturamento_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.venservicosalt.hd_faturamento_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.venservicosalt.hd_faturamento_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.venservicosalt.hd_faturamento_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
<?php
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venservicosalt.mgt_faturamento_srv_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Faturamento ***
      if(document.venservicosalt.mgt_faturamento_srv_cliente_desconto.value == '')
      {
         document.venservicosalt.mgt_faturamento_srv_cliente_desconto.value = 0;
      }
      document.venservicosalt.mgt_faturamento_srv_valor_desconto.value = ((parseFloat(document.venservicosalt.mgt_faturamento_srv_valor_pedido.value) * parseFloat(document.venservicosalt.mgt_faturamento_srv_cliente_desconto.value)) / 100).toFixed(2);
      document.venservicosalt.mgt_faturamento_srv_valor_total.value = (parseFloat(document.venservicosalt.mgt_faturamento_srv_valor_pedido.value) - parseFloat(document.venservicosalt.mgt_faturamento_srv_valor_desconto.value) + parseFloat(document.venservicosalt.mgt_faturamento_srv_valor_frete.value) + parseFloat(document.venservicosalt.mgt_faturamento_srv_valor_ipi.value)).toFixed(2);
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venservicosalt.mgt_faturamento_srv_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.bt_incluir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_observacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venservicosalt.mgt_faturamento_srv_cliente_transportadora.focus();
     return false;
   }
...
<?php
   ...
   function venservicosaltCreate($sender, $params)
   {
      ...
      $this->mgt_faturamento_cliente_numero->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_numero'];
      $this->mgt_faturamento_cliente_codigo->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_codigo'];
      $this->mgt_faturamento_cliente_nome->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_nome'];

      $this->hd_tipo_adicao->Value = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_tipo'];

      $this->mgt_faturamento_cliente_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_desconto'];
      $this->mgt_faturamento_data->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_data'];
      $this->mgt_faturamento_data_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_data_entrega'];
      $this->mgt_faturamento_cliente_condicao_pgto_1->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_1'];
      $this->mgt_faturamento_cliente_condicao_pgto_2->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_2'];
      $this->mgt_faturamento_cliente_condicao_pgto_3->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_3'];
      $this->mgt_faturamento_cliente_condicao_pgto_4->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_4'];
      $this->mgt_faturamento_cliente_condicao_pgto_5->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_5'];
      $this->mgt_faturamento_cliente_condicao_pgto_6->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_6'];
      $this->mgt_faturamento_cliente_condicao_pgto_7->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_7'];
      $this->mgt_faturamento_cliente_condicao_pgto_8->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_8'];
      $this->mgt_faturamento_cliente_condicao_pgto_9->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_9'];
      $this->mgt_faturamento_cliente_condicao_pgto_10->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_10'];
      $this->mgt_faturamento_cliente_condicao_pgto_11->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_11'];
      $this->mgt_faturamento_cliente_condicao_pgto_12->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_condicao_pgto_12'];
      $this->mgt_faturamento_cliente_observacao->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_observacao'];
      $this->mgt_faturamento_ordem_compra->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_ordem_compra'];

      $this->mgt_faturamento_valor_pedido->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_valor_pedido'];
      $this->mgt_faturamento_valor_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_valor_desconto'];
      $this->mgt_faturamento_valor_frete->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_valor_frete'];
      $this->mgt_faturamento_valor_ipi->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_valor_ipi'];
      $this->mgt_faturamento_valor_total->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_valor_total'];

      $this->mgt_faturamento_cliente_tipo_faturamento->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_tipo_faturamento'];
      $this->mgt_faturamento_cliente_transportadora->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_cliente_transportadora'];
      $this->mgt_faturamento_status->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Faturamentos_Srv->Fields['mgt_faturamento_srv_status'];
   ...
   function venservicosaltJSLoad($sender, $params)
   {
...
global $venservicosalt;

//Creates the form
$venservicosalt = new venservicosalt($application);

//Read from resource file
$venservicosalt->loadResource(__FILE__);
