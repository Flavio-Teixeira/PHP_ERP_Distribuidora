...
//Class definition
class comrequisicoesinc extends Page
{
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.comrequisicoesinc.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
      document.comrequisicoesinc.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
      document.comrequisicoesinc.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());

      document.comrequisicoesinc.hd_faturamento_cliente_desconto.value = '0';
      document.comrequisicoesinc.hd_faturamento_cliente_condicao_pgto_1.value = '0';
      document.comrequisicoesinc.hd_faturamento_cliente_condicao_pgto_2.value = '0';
      document.comrequisicoesinc.hd_faturamento_cliente_condicao_pgto_3.value = '0';
      document.comrequisicoesinc.hd_faturamento_cliente_condicao_pgto_4.value = '0';
      document.comrequisicoesinc.hd_faturamento_cliente_transportadora.value = '0';
      document.comrequisicoesinc.hd_faturamento_cliente_observacao.value = '';
<?php
...
?>
   ...
   {
     document.comrequisicoesinc.bt_buscar_fornecedor.focus();
     return false;
   }
<?php
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.opcao_busca_fornecedor.focus();
     return false;
   }
<?php
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_orcamento.focus();
     return false;
   }
<?php
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_vendedor.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_alterar_produto_ipi;
   ...
   document.comrequisicoesinc.mgt_alterar_produto_valor_total.value = (document.comrequisicoesinc.mgt_alterar_produto_qtde.value * document.comrequisicoesinc.mgt_alterar_produto_preco.value).toFixed(2);
   document.comrequisicoesinc.mgt_alterar_produto_valor_ipi.value   = ((document.comrequisicoesinc.mgt_alterar_produto_valor_total.value * document.comrequisicoesinc.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.bt_alterar_sim.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_alterar_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_alterar_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_alterar_produto_lote.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_alterar_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_alterar_produto_qtde.focus();
     return false;
   }
...
?>
      ...
      document.comrequisicoesinc.produto_remover_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.produto_remover_numero_pedido.value = document.comrequisicoesinc.mgt_pedido_numero.value;
      document.comrequisicoesinc.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.comrequisicoesinc.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.comrequisicoesinc.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_status.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.comrequisicoesinc.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.comrequisicoesinc.mgt_produto_qtde.value        = '0';
      document.comrequisicoesinc.mgt_produto_valor_total.value = '0.00';
      document.comrequisicoesinc.mgt_produto_valor_ipi.value   = '0.00';
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.bt_adicionar_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_produto_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_produto_qtde.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.comrequisicoesinc.mgt_produto_valor_total.value = (document.comrequisicoesinc.mgt_produto_qtde.value * document.comrequisicoesinc.mgt_produto_preco.value).toFixed(2);
   document.comrequisicoesinc.mgt_produto_valor_ipi.value   = ((document.comrequisicoesinc.mgt_produto_valor_total.value * document.comrequisicoesinc.mgt_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.bt_busca_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.opcao_busca_produto.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.comrequisicoesinc.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.comrequisicoesinc.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.comrequisicoesinc.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.comrequisicoesinc.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.comrequisicoesinc.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.comrequisicoesinc.MSG_Alerta.value = '';
      }

      document.comrequisicoesinc.hd_pedido_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.comrequisicoesinc.hd_pedido_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.comrequisicoesinc.hd_pedido_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.comrequisicoesinc.hd_pedido_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.comrequisicoesinc.hd_pedido_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.comrequisicoesinc.hd_pedido_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.comrequisicoesinc.hd_pedido_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
<?php
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comrequisicoesinc.mgt_pedido_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Pedido ***
      if(document.comrequisicoesinc.mgt_pedido_cliente_desconto.value == '')
      {
         document.comrequisicoesinc.mgt_pedido_cliente_desconto.value = 0;
      }
      document.comrequisicoesinc.mgt_pedido_valor_desconto.value = ((parseFloat(document.comrequisicoesinc.mgt_pedido_valor_pedido.value) * parseFloat(document.comrequisicoesinc.mgt_pedido_cliente_desconto.value)) / 100).toFixed(2);
      document.comrequisicoesinc.mgt_pedido_valor_total.value = (parseFloat(document.comrequisicoesinc.mgt_pedido_valor_pedido.value) - parseFloat(document.comrequisicoesinc.mgt_pedido_valor_desconto.value) + parseFloat(document.comrequisicoesinc.mgt_pedido_valor_frete.value) + parseFloat(document.comrequisicoesinc.mgt_pedido_valor_ipi.value)).toFixed(2);
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comrequisicoesinc.mgt_pedido_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.bt_incluir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_observacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_funcionario.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comrequisicoesinc.mgt_pedido_cliente_tipo_faturamento.focus();
     return false;
   }
...
<?php
   ...
   function comrequisicoesincCreate($sender, $params)
   {
   ...
   function bt_incluirClick($sender, $params)
   {
      ...
      {
         $this->MSG_Erro->Caption = "Por favor, preencha o campo de Numero da Requisicao.";
      }
      elseif(trim($this->mgt_pedido_cliente_numero->Text) == "")
      {
         $this->MSG_Erro->Caption = "Por favor, escolha um Fornecedor para esta Requisicao.";
      }
      else
      {
   ...
   function comrequisicoesincJSLoad($sender, $params)
   {
...
global $comrequisicoesinc;

//Creates the form
$comrequisicoesinc = new comrequisicoesinc($application);

//Read from resource file
$comrequisicoesinc->loadResource(__FILE__);

//Shows the form
$comrequisicoesinc->show();
