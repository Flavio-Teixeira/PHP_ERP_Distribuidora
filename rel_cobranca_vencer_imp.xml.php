<?php
<object class="relcobrancavencerimp" name="relcobrancavencerimp" baseclass="page">
  ...
  <property name="Name">relcobrancavencerimp</property>
  <property name="Width">784</property>
  <property name="OnCreate">relcobrancavencerimpCreate</property>
  <property name="jsOnLoad">relcobrancavencerimpJSLoad</property>
  ...
  <object class="Label" name="relatorio_titulo" >
    <property name="Alignment">agCenter</property>
    <property name="Caption"><![CDATA[Relatorio de Cobranca por Periodo - A Vencer]]></property>
    <property name="Font">
