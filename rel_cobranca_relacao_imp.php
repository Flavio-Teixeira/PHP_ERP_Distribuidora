...
//Definicao de classe
class relcobrancarelacaoimp extends Page
{
   public $logo_relatorio = null;
   public $mgt_swap_cobranca_finalidade = null;
   public $mgt_cobranca_receber = null;
   public $Label17 = null;
   public $mgt_cobranca_recebido = null;
   public $Label14 = null;
   public $Label11 = null;
   public $Label10 = null;
   public $Label6 = null;
   ...
   function relcobrancarelacaoimpCreate($sender, $params)
   {
         ...
         if((GetConexaoPrincipal()->SQL_MGT_Notas_Fiscais->EOF) != 1)
         {
            while((GetConexaoPrincipal()->SQL_MGT_Notas_Fiscais->EOF) != 1)
            {
               ...
               if(trim($dt_vcto_1) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_1)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_2) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_2)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_3) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_3)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_4) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_4)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_5) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_5)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_6) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_6)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_7) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_7)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_8) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_8)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_9) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_9)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_10) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_10)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_11) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_11)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
               ...
               if(trim($dt_vcto_12) != '')
               {
                  ...
                  (strtotime(trim($dt_vcto_12)) <= strtotime(inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption))))
                  )
                  {
      ...
      else
      {
         ...
         $Comando_SQL .= "(";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_1 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_1 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_2 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_2 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_3 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_3 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_4 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_4 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_5 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_5 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_6 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_6 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_7 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_7 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_8 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_8 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_9 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_9 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_10 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_10 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_11 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_11 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) or ";
         $Comando_SQL .= "((mgt_programada_dup_dt_vcto_12 >='" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') and ";
         $Comando_SQL .= "(mgt_programada_dup_dt_vcto_12 <='" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "'))";
         $Comando_SQL .= ") and ";
      ...
      //*** Seleciona o Total Recebido ***

      $Comando_SQL = "Select SUM(mgt_swap_cobranca_dup_vlr) AS mgt_total_geral_cobrancas from mgt_swap_cobrancas Where mgt_swap_cobranca_dup_dt_pgto > '0000-00-00' Order By mgt_swap_cobranca_dup_dt_vcto, mgt_swap_cobranca_dup_nro";

      GetConexaoPrincipal()->SQL_MGT_Cobrancas->Close();
      GetConexaoPrincipal()->SQL_MGT_Cobrancas->SQL = $Comando_SQL;
      GetConexaoPrincipal()->SQL_MGT_Cobrancas->Open();

      $this->mgt_cobranca_recebido->Caption = GetConexaoPrincipal()->SQL_MGT_Cobrancas->Fields['mgt_total_geral_cobrancas'];

      //*** Seleciona o Total a Receber ***

      $this->mgt_cobranca_receber->Caption = number_format(($this->mgt_cobranca_total->Caption - $this->mgt_cobranca_recebido->Caption), "2", ".", "");

      //*** Obtem os Dados do Relatorio ***

      $Comando_SQL = "Select *,mgt_swap_cobranca_dup_dt_vcto AS mgt_swap_cobranca_dup_dt_vcto_ord,date_format(mgt_swap_cobranca_data_emissao, '%d/%m/%Y') AS mgt_swap_cobranca_data_emissao,date_format(mgt_swap_cobranca_dup_dt_vcto, '%d/%m/%Y') AS mgt_swap_cobranca_dup_dt_vcto,date_format(mgt_swap_cobranca_dup_dt_pgto, '%d/%m/%Y') AS mgt_swap_cobranca_dup_dt_pgto from mgt_swap_cobrancas Order By mgt_swap_cobranca_dup_dt_vcto_ord, mgt_swap_cobranca_dup_nro";

      GetConexaoPrincipal()->SQL_MGT_Cobrancas->Close();
      GetConexaoPrincipal()->SQL_MGT_Cobrancas->SQL = $Comando_SQL;
      GetConexaoPrincipal()->SQL_MGT_Cobrancas->Open();
   }
   function relcobrancarelacaoimpJSLoad($sender, $params)
   {
...
global $relcobrancarelacaoimp;

//Cria o formulario
$relcobrancarelacaoimp = new relcobrancarelacaoimp($application);

//Ler do arquivo de recursos
$relcobrancarelacaoimp->loadResource(__FILE__);

//Mostrar o formulario
$relcobrancarelacaoimp->show();
