<?php
<object class="cadncmsutilizadasalt" name="cadncmsutilizadasalt" baseclass="page">
  ...
  <property name="Name">cadncmsutilizadasalt</property>
  <property name="Width">755</property>
  <property name="OnCreate">cadncmsutilizadasaltCreate</property>
  <property name="jsOnLoad">cadncmsutilizadasaltJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[CADASTRO - NCMs Utilizadas - Alteracao / Consulta]]></property>
