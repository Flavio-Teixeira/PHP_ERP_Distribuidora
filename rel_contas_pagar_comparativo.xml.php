<?php
<object class="relcontaspagarcomparativo" name="relcontaspagarcomparativo" baseclass="Page">
  ...
  <property name="Name">relcontaspagarcomparativo</property>
  <property name="Width">755</property>
  <property name="OnCreate">relcontaspagarcomparativoCreate</property>
  <property name="jsOnLoad">relcontaspagarcomparativoJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE CONTAS A PAGAR - Comparativo a Pagar / a Receber]]></property>
  ...
  <object class="GroupBox" name="GroupBox4" >
    ...
    <object class="Label" name="Label5" >
      <property name="Caption"><![CDATA[ATENCAO: O Sistema ira Considerar a Conta Escolhida Como Padrao, tomando como base o primeiro saldo localizado entre o periodo escolhido. Caso a opcao escolhida seja todas as contas o Sistema somara os primeiros saldos encontrados no periodo informado.&lt;br&gt;&lt;br&gt;ATENCAO: Se a Data de Vencimento de um Contas a Receber e Contas a Pagar coincidirem em finais de Semana o Sistema ira Lanca-los na Segunda-Feira.]]></property>
