...
//Class definition
class pagfixosinc extends Page
{
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.pagfixosinc.adiciona_fornecedor_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.pagfixosinc.adiciona_fornecedor_codigo.value = registros.getTableModel().getValue(1, registros.getFocusedRow());
      document.pagfixosinc.adiciona_fornecedor_nome.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
...
?>
   //Adicione seu codigo javascript aqui
      ...
      {
        document.pagfixosinc.bt_buscar.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.opcao_busca.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.bt_adiciona_fornecedor.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.adiciona_fornecedor_nome.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.adiciona_fornecedor_codigo.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.pagfixosinc.mgt_titulo_fixo_fornecedor_numero.value = '0';
      document.pagfixosinc.mgt_titulo_fixo_fornecedor_nome.value = '--- Sem Fornecedor ---';
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.bt_incluir.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.mgt_titulo_fixo_fornecedor_nome.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.mgt_titulo_fixo_fornecedor_numero.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.mgt_titulo_fixo_data.focus();
        return false;
      }
...
?>
   ...
   var campo = document.pagfixosinc.mgt_titulo_fixo_data
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.mgt_titulo_fixo_valor.focus();
        return false;
      }
...
?>
   ...
   var campo = document.pagfixosinc.mgt_titulo_fixo_valor
   var digits="0123456789.-"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.pagfixosinc.mgt_titulo_fixo_dia
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.mgt_titulo_fixo_descricao.focus();
        return false;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.pagfixosinc.mgt_titulo_fixo_dia.focus();
        return false;
      }
...
?>
   ...
   var campo = document.pagfixosinc.mgt_conta_bancaria_nro
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
<?php
   ...
   function pagfixosincCreate($sender, $params)
   {
      ...
      $this->mgt_titulo_fixo_dia->Text = date("d", time());
      $this->mgt_titulo_fixo_valor->Text = "0.00";
      $this->mgt_titulo_fixo_data->Text = "00/00/0000";

      $this->mgt_titulo_fixo_fornecedor_numero->Text = "0";
      $this->mgt_titulo_fixo_fornecedor_nome->Text = "--- Sem Fornecedor ---";
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.pagfixosinc.mgt_conta_bancaria_banco.focus();
     return false;
   }
...
<?php
   ...
   function bt_incluirClick($sender, $params)
   {
      ...
      {
         $Comando_SQL = "Insert into mgt_titulos_fixos(";
         $Comando_SQL .= "mgt_titulo_fixo_dia, ";
         $Comando_SQL .= "mgt_titulo_fixo_descricao, ";
         $Comando_SQL .= "mgt_titulo_fixo_valor, ";
         $Comando_SQL .= "mgt_titulo_fixo_conta, ";
         $Comando_SQL .= "mgt_titulo_fixo_conta_descricao, ";
         $Comando_SQL .= "mgt_titulo_fixo_tipo, ";
         $Comando_SQL .= "mgt_titulo_fixo_data, ";
         $Comando_SQL .= "mgt_titulo_fixo_fornecedor_numero, ";
         $Comando_SQL .= "mgt_titulo_fixo_fornecedor_nome) ";
         $Comando_SQL .= "Values(";
         $Comando_SQL .= "'" . trim($this->mgt_titulo_fixo_dia->Text) . "', ";
         ...
         $Comando_SQL .= "'" . trim($this->mgt_titulo_fixo_conta->Items[$this->mgt_titulo_fixo_conta->ItemIndex]) . "', ";
         ...
         $Comando_SQL .= "'" . inverte_data_dma_to_amd(trim($this->mgt_titulo_fixo_data->Text)) . "',";
   ...
   function pagfixosincJSLoad($sender, $params)
   {
...
//Creates the form
$pagfixosinc = new pagfixosinc($application);

//Read from resource file
$pagfixosinc->loadResource(__FILE__);
