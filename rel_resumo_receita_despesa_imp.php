...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(20, 5, 'Receitas: ', $borda, 0, 'L');
      $this->Cell(25, 5, 'Recebidos', $borda, 0, 'L');
      $this->Cell(25, 5, 'Nao Recebidos', $borda, 0, 'L');
      $this->Cell(25, 5, 'Total', $borda, 0, 'L');
      $this->Cell(2, 5, '|', $borda, 0, 'L');
      $this->Cell(20, 5, 'Despesas: ', $borda, 0, 'L');
      $this->Cell(25, 5, 'Pagas', $borda, 0, 'L');
      $this->Cell(25, 5, 'Nao Pagas', $borda, 0, 'L');
      $this->Cell(23, 5, 'Total', $borda, 1, 'L');
...
function PDF_Detalhe()
{
   ...
   $pdf->SetName("Resumo Receita/Despesa de " . trim($_SESSION['imprime_data_inicial']) . " ate " . trim($_SESSION['imprime_data_final']));
   ...
   $Comando_SQL = "Select SUM(mgt_conta_pagar_valor_ser_pago) AS valor_pago from mgt_contas_pagar ";
   $Comando_SQL .= "Where ";
   $Comando_SQL .= "(";
   $Comando_SQL .= "mgt_conta_pagar_data >= '" . inverte_data_dma_to_amd(trim($_SESSION['imprime_data_inicial'])) . "'";
   $Comando_SQL .= " And ";
   $Comando_SQL .= "mgt_conta_pagar_data <= '" . inverte_data_dma_to_amd(trim($_SESSION['imprime_data_final'])) . "'";
   $Comando_SQL .= ")";
   $Comando_SQL .= " And ";
   ...
   $despesa_valor_pago = number_format(GetConexaoPrincipal()->SQL_Relatorio->Fields['valor_pago'], "2", ".", "");

   //*** Soma as Despesas Nao Pagas ***
   $Comando_SQL = "Select SUM(mgt_conta_pagar_valor_ser_pago) AS valor_nao_pago from mgt_contas_pagar ";
   $Comando_SQL .= "Where ";
   $Comando_SQL .= "(";
   $Comando_SQL .= "mgt_conta_pagar_data >= '" . inverte_data_dma_to_amd(trim($_SESSION['imprime_data_inicial'])) . "'";
   $Comando_SQL .= " And ";
   ...
   $despesa_nao_valor_pago = number_format(GetConexaoPrincipal()->SQL_Relatorio->Fields['valor_nao_pago'], "2", ".", "");

   //*** Total das Despesas ***

   $despesa_total = $despesa_valor_pago + $despesa_nao_valor_pago;
   ...
   //*** Soma as Receitas Pagas ***
   $Comando_SQL = "Select SUM(mgt_swap_cobranca_dup_vlr_pgto) AS valor_pago from mgt_swap_cobrancas ";
   $Comando_SQL .= "Where ";
   $Comando_SQL .= "(";
   ...
   $Comando_SQL .= ")";
   $Comando_SQL .= " And ";
   $Comando_SQL .= "mgt_swap_cobranca_dup_dt_pgto > '0000-00-00'";

   GetConexaoPrincipal()->SQL_Relatorio->Close();
   GetConexaoPrincipal()->SQL_Relatorio->SQL = $Comando_SQL;
   GetConexaoPrincipal()->SQL_Relatorio->Open();

   $receita_valor_pago = number_format(GetConexaoPrincipal()->SQL_Relatorio->Fields['valor_pago'], "2", ".", "");

   //*** Soma as Receitas Nao Pagas ***
   $Comando_SQL = "Select SUM(mgt_swap_cobranca_dup_vlr) AS valor_nao_pago from mgt_swap_cobrancas ";
   $Comando_SQL .= "Where ";
   $Comando_SQL .= "(";
   $Comando_SQL .= "mgt_swap_cobranca_dup_dt_vcto >= '" . inverte_data_dma_to_amd(trim($_SESSION['imprime_data_inicial'])) . "'";
   $Comando_SQL .= " And ";
   ...
   $pdf->Cell(25, 5, number_format($receita_valor_pago, "2", ".", ""), $borda, 0, 'L');
   $pdf->Cell(25, 5, number_format($receita_nao_valor_pago, "2", ".", ""), $borda, 0, 'L');
   $pdf->Cell(25, 5, number_format($receita_total, "2", ".", ""), $borda, 0, 'L');
   $pdf->Cell(2, 5, '|', $borda, 0, 'L');
   $pdf->Cell(20, 5, '', $borda, 0, 'L');
   $pdf->Cell(25, 5, number_format($despesa_valor_pago, "2", ".", ""), $borda, 0, 'L');
   $pdf->Cell(25, 5, number_format($despesa_nao_valor_pago, "2", ".", ""), $borda, 0, 'L');
   $pdf->Cell(23, 5, number_format($despesa_total, "2", ".", ""), $borda, 1, 'L');
   ...
   $pdf->Cell(100, 5, 'Total: Receita - Despesa:', $borda, 0, 'R');
   $pdf->Cell(28, 5, number_format($receita_total - $despesa_total, "2", ".", ""), $borda, 1, 'L');
