...
//Class definition
class comentradanotaalt extends Page
{
   public $hd_origem = null;
   public $mgt_operacao_cadastro_motivo = null;
   public $Label132 = null;
   public $Label129 = null;
   public $confirmacao_exclusao = null;
   public $bt_excluir_nf_sim = null;
   public $bt_excluir_nf_nao = null;
   public $bt_excluir = null;
   public $bt_altera_nf = null;
   ...
   function bt_excluir_nf_simClick($sender, $params)
   {
      if(trim($this->mgt_operacao_cadastro_motivo->text) <> '')
      {
         ...
         $Comando_SQL = "delete from mgt_notas_entradas ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_nota_entrada_numero='" . trim($this->mgt_nota_fiscal_faturamento->Text) . "'";
         ...
         //*** Deleta totdos o Produtos da Nota de Entrada ***

         $Comando_SQL = "delete from mgt_notas_entradas_produtos ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_nota_entrada_produto_numero_nota='" . trim($this->mgt_nota_fiscal_faturamento->Text) . "'";
         ...
         $this->confirmacao_exclusao->Top = 1795;
         $this->confirmacao_exclusao->IsVisible = false;
   ...
   function bt_excluir_nf_naoClick($sender, $params)
   {
      $this->confirmacao_exclusao->Top = 1795;
      $this->confirmacao_exclusao->IsVisible = false;
   }
   ...
   {
      $this->confirmacao_exclusao->Top = 84;
      $this->confirmacao_exclusao->IsVisible = true;
   }

   function bt_altera_nfClick($sender, $params)
   {
      ...
      else
      {
         ...
         //*** Efetua os Ajustes de Estoque Caso a Nota Tenha Vindo da Ordem de Compra ***

         if(trim($this->hd_origem->value) == 'oc')
         {
            ...
            if(trim($this->mgt_nota_fiscal_dup_nro_1->Text) <> "")
            {
               ...
               $Comando_SQL .= "'0.00', ";
               $Comando_SQL .= "'0.00', ";
               $Comando_SQL .= "'GERADA PELA NOTA DE ENTRADA NRO.: " . trim($this->mgt_nota_fiscal_numero->Text) . "', ";
               $Comando_SQL .= "'0.00', ";
               $Comando_SQL .= "'0', ";
               $Comando_SQL .= "'', ";
               $Comando_SQL .= "'0000-00-00')";
            ...
            $Comando_SQL .= "'" . trim($_SESSION['login_usuario']) . "',";
            $Comando_SQL .= "'" . trim($this->area_sistema->Caption) . "',";
            $Comando_SQL .= "'" . 'Inclusao' . "',";
            $Comando_SQL .= "'" . trim($this->mgt_nota_fiscal_faturamento->Text) . "',";
            $Comando_SQL .= "'" . 'Inclusao Efetuada pelo Usuario.' . "')";
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_total;
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_outras_despesas;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_seguro;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_frete;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_produtos;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_icms_sub;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_base_icms_sub;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_icms;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_base_icms;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_valor_desconto;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_base_aliquota_icms_reduzida;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_aliquota_icms;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   {
     document.comentradanotaalt.mgt_alterar_produto_descricao.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.comentradanotaalt.mgt_produto_descricao.focus();
        return false;
      }
   ...
   var campo = document.comentradanotaalt.mgt_alterar_produto_ncm
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_alterar_produto_situacao_tributaria
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.bt_alterar_sim.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_ncm.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_situacao_tributaria.focus();
     return false;
   }
   ...
   var campo = document.comentradanotaalt.mgt_alterar_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.comentradanotaalt.mgt_alterar_produto_valor_total.value = (document.comentradanotaalt.mgt_alterar_produto_qtde.value * document.comentradanotaalt.mgt_alterar_produto_preco.value).toFixed(2);
   document.comentradanotaalt.mgt_alterar_produto_valor_ipi.value   = ((document.comentradanotaalt.mgt_alterar_produto_valor_total.value * document.comentradanotaalt.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
   ...
   var campo = document.comentradanotaalt.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_unidade.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_lote.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_preco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_qtde.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_ipi.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_alterar_produto_classificacao_fiscal.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.comentradanotaalt.produto_remover_numero.value = registros_produtos.getTableModel().getValue(15, registros_produtos.getFocusedRow());
      document.comentradanotaalt.produto_remover_numero_pedido.value = document.comentradanotaalt.mgt_nota_fiscal_faturamento.value;
      document.comentradanotaalt.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.comentradanotaalt.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.comentradanotaalt.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(15, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(11, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_classificacao_fiscal.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_situacao_tributaria.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.comentradanotaalt.hd_alterar_produto_ncm.value = registros_produtos.getTableModel().getValue(14, registros_produtos.getFocusedRow());
      <?php
   ...
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comentradanotaalt.mgt_produto_ncm
      var digits="0123456789"
      var campo_temp
      for (var i=0;i<campo.value.length;i++){
          campo_temp=campo.value.substring(i,i+1)
   ...
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.comentradanotaalt.mgt_produto_situacao_tributaria
      var digits="0123456789"
      var campo_temp
      for (var i=0;i<campo.value.length;i++){
          campo_temp=campo.value.substring(i,i+1)
   ...
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.comentradanotaalt.bt_adicionar_produto.focus();
        return false;
      }
   ...
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.comentradanotaalt.mgt_produto_ncm.focus();
        return false;
      }
   ...
   //Adicione seu codigo javascript aqui
      ...
      if((event.keyCode == 9) || (event.keyCode == 13) )
      {
        document.comentradanotaalt.mgt_produto_situacao_tributaria.focus();
        return false;
      }
   ...
   var campo = document.comentradanotaalt.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.comentradanotaalt.mgt_produto_valor_total.value = (document.comentradanotaalt.mgt_produto_qtde.value * document.comentradanotaalt.mgt_produto_preco.value).toFixed(2);
   document.comentradanotaalt.mgt_produto_valor_ipi.value   = ((document.comentradanotaalt.mgt_produto_valor_total.value * document.comentradanotaalt.mgt_produto_ipi.value) / 100).toFixed(2);
   ...
   var campo = document.comentradanotaalt.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_produto_classificacao_fiscal.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_produto_ipi.focus();
     return false;
   }
   ...
   var campo = document.comentradanotaalt.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.comentradanotaalt.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_qtde.value        = '0';
      document.comentradanotaalt.mgt_produto_valor_total.value = '0.00';
      document.comentradanotaalt.mgt_produto_valor_ipi.value   = '0.00';

      document.comentradanotaalt.mgt_produto_classificacao_fiscal.value  = registros_produtos_busca.getTableModel().getValue(7, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_situacao_tributaria.value  = registros_produtos_busca.getTableModel().getValue(8, registros_produtos_busca.getFocusedRow());
      document.comentradanotaalt.mgt_produto_ncm.value  = registros_produtos_busca.getTableModel().getValue(9, registros_produtos_busca.getFocusedRow());
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_produto_unidade.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_produto_lote.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_produto_preco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_produto_qtde.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.bt_busca_produto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.opcao_busca_produto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.bt_buscar_fornecedor.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.opcao_busca_fornecedor.focus();
     return false;
   }
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.comentradanotaalt.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
      document.comentradanotaalt.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
      document.comentradanotaalt.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_12;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_11;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_10;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_9;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_8;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_7;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_6;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_5;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_4;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_3;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_2;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_1;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_12
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_11
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_10
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_9
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_8
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_7
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_6
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_5
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_4
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_3
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_2
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_1
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_data_emissao
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_suframa.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_suframa_desconto_pis_cofins.focus();
     return false;
   }
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_suframa_desconto_pis_cofins;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_suframa_desconto_icms;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_codigo.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_nome.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_razao_social.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_inscricao_estadual.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_inscricao_municipal.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.bt_fechar.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_complemento.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_bairro.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cidade.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_estado.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cep.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_pais.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_fone.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_fax.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_ddd.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_fone_comercial.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_fone_celular.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_fone_fax.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_email.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_site.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cfop.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_data_emissao.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_numero.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_suframa_desconto_icms.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cfop_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_observacao_nota.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_desconto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_data.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_ordem_compra.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_natureza_operacao.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.bt_altera_nf.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_1.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_1.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_1.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_2.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_3.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_3.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_3.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_3.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_4.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_4.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_4.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_4.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_5.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_5.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_5.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_5.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_6.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_6.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_6.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_6.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_7.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_7.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_7.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_7.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_8.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_8.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_8.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_8.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_9.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_9.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_9.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_9.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_10.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_10.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_10.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_10.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_11.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_11.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_11.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_11.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_cliente_condicao_pgto_12.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_nro_12.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_dt_vcto_12.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_dup_vlr_12.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_tipo_transporte.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_razao_social.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_veiculo_placa.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_veiculo_estado.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_cnpj.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_insc_est.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_insc_mun.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_endereco.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_complemento.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_bairro.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_cidade.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_estado.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_transportadora_cep.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_qtde.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_especie.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_marca.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_vol_numero.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_peso_bruto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_peso_liquido.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_base_aliquota_icms_reduzida.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_desconto.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_base_icms.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_icms.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_base_icms_sub.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_icms_sub.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_produtos.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_frete.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_seguro.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_outras_despesas.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_ipi.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.comentradanotaalt.mgt_nota_fiscal_valor_total.focus();
     return false;
   }
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_peso_liquido;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_peso_bruto;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_qtde
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cfop_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_cfop
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   var campo = document.comentradanotaalt.mgt_nota_fiscal_numero
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   function comentradanotaaltCreate($sender, $params)
   {
      ...
      $mgt_origem = $_REQUEST['mgt_origem'];
      $this->hd_origem->Value = $mgt_origem;
      ...
      $Comando_SQL = "select *,date_format(mgt_nota_entrada_data, '%d/%m/%Y') AS mgt_nota_entrada_data, date_format(mgt_nota_entrada_data_emissao, '%d/%m/%Y') AS mgt_nota_entrada_data_emissao, date_format(mgt_nota_entrada_data_entrega, '%d/%m/%Y') AS mgt_nota_entrada_data_entrega from mgt_notas_entradas where mgt_nota_entrada_numero = " . trim($this->mgt_nota_fiscal_faturamento->Text) . " order by mgt_nota_entrada_numero Asc";

      GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Close();
      GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->SQL = $Comando_SQL;
      GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Open();

      $this->mgt_nota_fiscal_numero->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_numero_nota'];
      $this->mgt_nota_fiscal_cfop->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cfop'];
      $this->mgt_nota_fiscal_cfop_2->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cfop_2'];
      $this->mgt_nota_fiscal_natureza_operacao->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_natureza_operacao'];
      $this->mgt_nota_fiscal_natureza_operacao->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_natureza_operacao_imp'];
      $this->mgt_nota_fiscal_cliente_numero->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_numero'];
      $this->mgt_nota_fiscal_cliente_codigo->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_codigo'];
      $this->mgt_nota_fiscal_cliente_nome->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_nome'];
      $this->mgt_nota_fiscal_razao_social->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_razao_social'];
      $this->mgt_nota_fiscal_inscricao_estadual->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_inscricao_municipal'];
      $this->mgt_nota_fiscal_inscricao_municipal->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_inscricao_estadual'];
      $this->mgt_nota_fiscal_endereco->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_endereco'];
      $this->mgt_nota_fiscal_complemento->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_complemento'];
      $this->mgt_nota_fiscal_bairro->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bairro'];
      $this->mgt_nota_fiscal_cidade->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cidade'];
      $this->mgt_nota_fiscal_estado->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_estado'];
      $this->mgt_nota_fiscal_cep->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cep'];
      $this->mgt_nota_fiscal_pais->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_pais'];
      $this->mgt_nota_fiscal_fone->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_fone'];
      $this->mgt_nota_fiscal_fax->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_fax'];
      $this->mgt_nota_fiscal_contato->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_contato'];
      $this->mgt_nota_fiscal_ddd->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_ddd'];
      $this->mgt_nota_fiscal_fone_comercial->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_fone_comercial'];
      $this->mgt_nota_fiscal_fone_celular->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_fone_celular'];
      $this->mgt_nota_fiscal_fone_fax->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_fone_fax'];
      $this->mgt_nota_fiscal_email->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_email'];
      $this->mgt_nota_fiscal_site->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_site'];
      $this->mgt_nota_fiscal_cliente_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_desconto'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_1->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_1'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_2->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_2'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_3->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_3'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_4->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_4'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_5->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_5'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_6->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_6'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_7->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_7'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_8->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_8'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_9->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_9'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_10->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_10'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_11->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_11'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_12->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_cliente_condicao_pgto_12'];
      $this->mgt_nota_fiscal_tipo_transporte->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_tipo_transporte'];
      $this->mgt_nota_fiscal_pagamento_frete->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora'];
      $this->mgt_nota_fiscal_valor_produtos->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_pedido'];
      $this->mgt_nota_fiscal_valor_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_desconto'];
      $this->mgt_nota_fiscal_valor_frete->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_frete'];
      $this->mgt_nota_fiscal_valor_ipi->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_ipi'];
      $this->mgt_nota_fiscal_valor_total->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_total'];
      $this->mgt_nota_fiscal_observacao_nota->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_observacao_nota'];
      $this->mgt_nota_fiscal_pagamento_frete->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_pagamento_frete'];
      $this->mgt_nota_fiscal_aliquota_icms->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_aliquota_icms'];
      $this->mgt_nota_fiscal_base_aliquota_icms_reduzida->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_base_aliquota_icms_reduzida'];
      $this->mgt_nota_fiscal_qtde->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_qtde'];
      $this->mgt_nota_fiscal_especie->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_especie'];
      $this->mgt_nota_fiscal_marca->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_marca'];
      $this->mgt_nota_fiscal_vol_numero->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_vol_numero'];
      $this->mgt_nota_fiscal_peso_bruto->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_peso_bruto'];
      $this->mgt_nota_fiscal_peso_liquido->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_peso_liquido'];
      $this->mgt_nota_fiscal_data_emissao->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_data'];
      $this->mgt_nota_fiscal_data->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_data'];
      $this->mgt_nota_fiscal_suframa_desconto_icms->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_suframa_desconto_icms'];
      $this->mgt_nota_fiscal_suframa_desconto_pis_cofins->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_suframa_desconto_pis_cofins'];
      $this->mgt_nota_fiscal_suframa->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_suframa'];
      $this->mgt_nota_fiscal_ordem_compra->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_ordem_compra'];
      $this->mgt_nota_fiscal_dup_nro_1->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_1'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_1->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_1'];
      $this->mgt_nota_fiscal_dup_dt_vcto_1->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_1']));
      $this->mgt_nota_fiscal_dup_vlr_1->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_1'];
      $this->mgt_nota_fiscal_dup_vlr_1->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_1'];
      $this->mgt_nota_fiscal_dup_nro_2->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_2'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_2->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_2'];
      $this->mgt_nota_fiscal_dup_dt_vcto_2->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_2']));
      $this->mgt_nota_fiscal_dup_vlr_2->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_2'];
      $this->mgt_nota_fiscal_dup_vlr_2->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_2'];
      $this->mgt_nota_fiscal_dup_nro_3->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_3'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_3->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_3'];
      $this->mgt_nota_fiscal_dup_dt_vcto_3->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_3']));
      $this->mgt_nota_fiscal_dup_vlr_3->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_3'];
      $this->mgt_nota_fiscal_dup_vlr_3->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_3'];
      $this->mgt_nota_fiscal_dup_nro_4->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_4'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_4->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_4'];
      $this->mgt_nota_fiscal_dup_dt_vcto_4->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_4']));
      $this->mgt_nota_fiscal_dup_vlr_4->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_4'];
      $this->mgt_nota_fiscal_dup_vlr_4->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_4'];
      $this->mgt_nota_fiscal_dup_nro_5->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_5'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_5->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_5'];
      $this->mgt_nota_fiscal_dup_dt_vcto_5->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_5']));
      $this->mgt_nota_fiscal_dup_vlr_5->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_5'];
      $this->mgt_nota_fiscal_dup_vlr_5->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_5'];
      $this->mgt_nota_fiscal_dup_nro_6->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_6'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_6->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_6'];
      $this->mgt_nota_fiscal_dup_dt_vcto_6->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_6']));
      $this->mgt_nota_fiscal_dup_vlr_6->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_6'];
      $this->mgt_nota_fiscal_dup_vlr_6->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_6'];
      $this->mgt_nota_fiscal_dup_nro_7->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_7'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_7->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_7'];
      $this->mgt_nota_fiscal_dup_dt_vcto_7->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_7']));
      $this->mgt_nota_fiscal_dup_vlr_7->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_7'];
      $this->mgt_nota_fiscal_dup_vlr_7->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_7'];
      $this->mgt_nota_fiscal_dup_nro_8->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_8'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_8->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_8'];
      $this->mgt_nota_fiscal_dup_dt_vcto_8->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_8']));
      $this->mgt_nota_fiscal_dup_vlr_8->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_8'];
      $this->mgt_nota_fiscal_dup_vlr_8->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_8'];
      $this->mgt_nota_fiscal_dup_nro_9->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_9'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_9->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_9'];
      $this->mgt_nota_fiscal_dup_dt_vcto_9->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_9']));
      $this->mgt_nota_fiscal_dup_vlr_9->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_9'];
      $this->mgt_nota_fiscal_dup_vlr_9->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_9'];
      $this->mgt_nota_fiscal_dup_nro_10->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_10'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_10->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_10'];
      $this->mgt_nota_fiscal_dup_dt_vcto_10->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_10']));
      $this->mgt_nota_fiscal_dup_vlr_10->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_10'];
      $this->mgt_nota_fiscal_dup_vlr_10->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_10'];
      $this->mgt_nota_fiscal_dup_nro_11->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_11'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_11->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_11'];
      $this->mgt_nota_fiscal_dup_dt_vcto_11->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_11']));
      $this->mgt_nota_fiscal_dup_vlr_11->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_11'];
      $this->mgt_nota_fiscal_dup_vlr_11->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_11'];
      $this->mgt_nota_fiscal_dup_nro_12->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_nro_12'];
      $this->mgt_nota_fiscal_cliente_condicao_pgto_12->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_forma_12'];
      $this->mgt_nota_fiscal_dup_dt_vcto_12->Text = inverte_data_amd_to_dma(trim(GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_dt_vcto_12']));
      $this->mgt_nota_fiscal_dup_vlr_12->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_dup_vlr_12'];
      $this->mgt_nota_fiscal_dup_vlr_12->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_bol_vlr_12'];
      $this->mgt_nota_fiscal_base_icms->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_base_icms'];
      $this->mgt_nota_fiscal_valor_icms->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_icms'];
      $this->mgt_nota_fiscal_valor_seguro->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_seguro'];
      $this->mgt_nota_fiscal_base_icms_sub->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_base_icms_sub'];
      $this->mgt_nota_fiscal_valor_icms_sub->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_icms_sub'];
      $this->mgt_nota_fiscal_valor_produtos->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_valor_produtos'];
      $this->mgt_nota_fiscal_outras_despesas->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_outras_despesas'];
      $this->mgt_nota_fiscal_transportadora_cnpj->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_cnpj'];
      $this->mgt_nota_fiscal_transportadora_razao_social->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_razao_social'];
      $this->mgt_nota_fiscal_transportadora_endereco->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_endereco'];
      $this->mgt_nota_fiscal_transportadora_complemento->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_complemento'];
      $this->mgt_nota_fiscal_transportadora_bairro->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_bairro'];
      $this->mgt_nota_fiscal_transportadora_cidade->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_cidade'];
      $this->mgt_nota_fiscal_transportadora_estado->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_estado'];
      $this->mgt_nota_fiscal_transportadora_cep->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_cep'];
      $this->mgt_nota_fiscal_transportadora_insc_est->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_insc_est'];
      $this->mgt_nota_fiscal_transportadora_insc_mun->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_insc_mun'];
      $this->mgt_nota_fiscal_transportadora_veiculo_estado->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_veiculo_estado'];
      $this->mgt_nota_fiscal_transportadora_veiculo_placa->Text = GetConexaoPrincipal()->SQL_MGT_Notas_Entradas->Fields['mgt_nota_entrada_transportadora_veiculo_placa'];
   ...
   function comentradanotaaltJSLoad($sender, $params)
   {
...
global $comentradanotaalt;

//Creates the form
$comentradanotaalt = new comentradanotaalt($application);

//Read from resource file
$comentradanotaalt->loadResource(__FILE__);

//Shows the form
$comentradanotaalt->show();
