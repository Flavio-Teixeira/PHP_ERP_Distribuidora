<?php
<object class="mgtnfereimprimirnfse" name="mgtnfereimprimirnfse" baseclass="page">
  ...
  <property name="Name">mgtnfereimprimirnfse</property>
  <property name="Width">755</property>
  <property name="OnCreate">mgtnfereimprimirnfseCreate</property>
  <property name="jsOnLoad">mgtnfereimprimirnfseJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[EMISSAO DA NOTA FISCAL - DANFE NFS-e - Reimprimir DANFE]]></property>
    <property name="Height">13</property>
    <property name="Name">area_sistema</property>
    <property name="Width">730</property>
  </object>
  <object class="GroupBox" name="GroupBox1" >
    <property name="Caption"><![CDATA[Reimpressao do DANFE - NFS-e]]></property>
