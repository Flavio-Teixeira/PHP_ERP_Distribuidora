<?php
<object class="relcobrancavencidoimp" name="relcobrancavencidoimp" baseclass="Page">
  ...
  <property name="Name">relcobrancavencidoimp</property>
  <property name="Width">784</property>
  <property name="OnCreate">relcobrancavencidoimpCreate</property>
  <property name="jsOnLoad">relcobrancavencidoimpJSLoad</property>
  ...
  <object class="Label" name="relatorio_titulo" >
    <property name="Alignment">agCenter</property>
    <property name="Caption"><![CDATA[Relatorio de Cobranca por Periodo - Vencidos e Nao Pagos]]></property>
    <property name="Font">
