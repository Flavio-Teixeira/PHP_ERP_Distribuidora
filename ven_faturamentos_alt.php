...
//Class definition
class venfaturamentosalt extends Page
{
    public $Label75 = null;
   ...
   public $bt_alterar_faturamento = null;
   ...
   public $mgt_faturamento_status = null;
   ...
   function bt_adiciona_fornecedorClick($sender, $params)
   {
      ...
      $this->adiciona_fornecedor->Top = 1565;
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venfaturamentosalt.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
      document.venfaturamentosalt.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
      document.venfaturamentosalt.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());

      document.venfaturamentosalt.hd_faturamento_cliente_desconto.value = '0';
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_1.value = '0';
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_2.value = '0';
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_3.value = '0';
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_4.value = '0';
      document.venfaturamentosalt.hd_faturamento_cliente_transportadora.value = '0';
      document.venfaturamentosalt.hd_faturamento_cliente_observacao.value = '';
...
?>
   ...
   {
     document.venfaturamentosalt.bt_buscar_fornecedor.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.opcao_busca_fornecedor.focus();
     return false;
   }
...
<?php
   ...
   function bt_sim_exclusaoClick($sender, $params)
   {
      if(trim($this->mgt_operacao_cadastro_motivo->text) <> '')
      {
         ...
         $Comando_SQL = "delete from mgt_faturamentos ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_faturamento_numero='" . trim($this->mgt_faturamento_numero->Text) . "'";
         ...
         //*** Deleta os Produtos dos Faturamentos ***

         $Comando_SQL = "delete from mgt_faturamentos_produtos ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_faturamento_produto_numero_pedido='" . trim($this->mgt_faturamento_numero->Text) . "'";
         ...
         //*** Volta o Pedido para a Fila de Espera ***

         $Comando_SQL = "select * from mgt_pedidos ";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_pedido_numero_faturamento like '%" . trim($this->mgt_faturamento_numero->Text) . ",%' ";
		 ...
		 $nro_pedido_produto =  GetConexaoPrincipal()->SQL_MGT_Pedidos->Fields['mgt_pedido_numero'];

		 if($nro_pedido_produto == '')
		 {
 		    $nro_pedido_produto = 0;
		 }

         $Comando_SQL = "update mgt_pedidos_produtos set ";
         $Comando_SQL .= "mgt_pedido_produto_quantidade_faturado = '0.000', mgt_pedido_produto_quantidade_faturar = '0.000'";
         $Comando_SQL .= " where ";
         $Comando_SQL .= "mgt_pedido_produto_numero_pedido = '" . trim($nro_pedido_produto) . "'";
   ...
   public function totaliza_faturamento()
   {
      ...
      $valor_total = (($valor_faturamento + $valor_ipi) + $frete);
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_alterar_produto_ipi;
   ...
   document.venfaturamentosalt.mgt_alterar_produto_valor_total.value = (document.venfaturamentosalt.mgt_alterar_produto_qtde.value * document.venfaturamentosalt.mgt_alterar_produto_preco.value).toFixed(2);
   document.venfaturamentosalt.mgt_alterar_produto_valor_ipi.value   = ((document.venfaturamentosalt.mgt_alterar_produto_valor_total.value * document.venfaturamentosalt.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.bt_alterar_sim.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_alterar_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_alterar_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_alterar_produto_lote.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_alterar_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_alterar_produto_qtde.focus();
     return false;
   }
...
<?php
   ...
   function bt_alterar_simClick($sender, $params)
   {
      if((trim($this->mgt_alterar_produto_codigo->Text) <> '')and(trim($this->mgt_alterar_produto_qtde->Text) <> '')and(trim($this->mgt_alterar_produto_qtde->Text) > 0))
      {
		 ...
		 $Comando_SQL .= "mgt_faturamento_produto_codigo_barras = '" . trim($this->mgt_alterar_produto_codigo_barras->Text) . "'";
         $Comando_SQL .= " where ";
...
?>
      ...
      document.venfaturamentosalt.produto_remover_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.produto_remover_numero_faturamento.value = document.venfaturamentosalt.mgt_faturamento_numero.value;
      document.venfaturamentosalt.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.venfaturamentosalt.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.venfaturamentosalt.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
	  document.venfaturamentosalt.hd_alterar_produto_codigo_barras.value = registros_produtos.getTableModel().getValue(11, registros_produtos.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_tipo_faturamento.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venfaturamentosalt.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosalt.mgt_produto_qtde.value        = '0';
      document.venfaturamentosalt.mgt_produto_valor_total.value = '0.00';
      document.venfaturamentosalt.mgt_produto_valor_ipi.value   = '0.00';
	  document.venfaturamentosalt.mgt_produto_codigo_barras.value = registros_produtos_busca.getTableModel().getValue(7, registros_produtos_busca.getFocusedRow());
...
<?php
   ...
   function bt_adicionar_produtoClick($sender, $params)
   {
      if((trim($this->mgt_produto_codigo->Text) <> '')and(trim($this->mgt_produto_qtde->Text) <> '')and(trim($this->mgt_produto_qtde->Text) > 0)and(trim($this->mgt_produto_codigo_barras->Text) > 0))
      {
		 ...
		 $Comando_SQL .= "mgt_faturamento_produto_codigo_barras) ";
         $Comando_SQL .= "values(";
         $Comando_SQL .= "'" . trim($this->mgt_faturamento_numero->Text) . "',";
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.bt_adicionar_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_produto_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_produto_qtde.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.venfaturamentosalt.mgt_produto_valor_total.value = (document.venfaturamentosalt.mgt_produto_qtde.value * document.venfaturamentosalt.mgt_produto_preco.value).toFixed(2);
   document.venfaturamentosalt.mgt_produto_valor_ipi.value   = ((document.venfaturamentosalt.mgt_produto_valor_total.value * document.venfaturamentosalt.mgt_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.bt_busca_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.opcao_busca_produto.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venfaturamentosalt.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.venfaturamentosalt.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.venfaturamentosalt.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.venfaturamentosalt.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.venfaturamentosalt.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.venfaturamentosalt.MSG_Alerta.value = '';
      }

      document.venfaturamentosalt.hd_faturamento_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.venfaturamentosalt.hd_faturamento_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.venfaturamentosalt.hd_faturamento_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.venfaturamentosalt.hd_faturamento_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
<?php
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venfaturamentosalt.mgt_faturamento_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Faturamento ***
      if(document.venfaturamentosalt.mgt_faturamento_cliente_desconto.value == '')
      {
         document.venfaturamentosalt.mgt_faturamento_cliente_desconto.value = 0;
      }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venfaturamentosalt.mgt_faturamento_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
      ...
      document.venfaturamentosalt.mgt_faturamento_valor_total.value = (parseFloat(document.venfaturamentosalt.mgt_faturamento_valor_pedido.value) + parseFloat(document.venfaturamentosalt.mgt_faturamento_valor_frete.value) + parseFloat(document.venfaturamentosalt.mgt_faturamento_valor_ipi.value)).toFixed(2);
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.bt_alterar_faturamento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_observacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosalt.mgt_faturamento_cliente_transportadora.focus();
     return false;
   }
...
<?php
   ...
   function venfaturamentosaltCreate($sender, $params)
   {
      ...
      if($tag_permissao == "2")
      {
        ...
        if( isset($this->bt_alterar_faturamento) )
        {
           $this->bt_alterar_faturamento->Visible = false;
        }
      ...
      $this->mgt_faturamento_cliente_numero->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_numero'];
      $this->mgt_faturamento_cliente_codigo->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_codigo'];
      $this->mgt_faturamento_cliente_nome->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_nome'];

      $this->hd_tipo_adicao->Value = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_tipo'];

      $this->mgt_faturamento_cliente_desconto->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_desconto'];
      $this->mgt_faturamento_data->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_data'];
      $this->mgt_faturamento_data_entrega->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_data_entrega'];
      $this->mgt_faturamento_cliente_condicao_pgto_1->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_1'];
      $this->mgt_faturamento_cliente_condicao_pgto_2->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_2'];
      $this->mgt_faturamento_cliente_condicao_pgto_3->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_3'];
      $this->mgt_faturamento_cliente_condicao_pgto_4->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_4'];
      $this->mgt_faturamento_cliente_condicao_pgto_5->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_5'];
      $this->mgt_faturamento_cliente_condicao_pgto_6->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_6'];
      $this->mgt_faturamento_cliente_condicao_pgto_7->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_7'];
      $this->mgt_faturamento_cliente_condicao_pgto_8->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_8'];
      $this->mgt_faturamento_cliente_condicao_pgto_9->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_9'];
      $this->mgt_faturamento_cliente_condicao_pgto_10->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_10'];
      $this->mgt_faturamento_cliente_condicao_pgto_11->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_11'];
      $this->mgt_faturamento_cliente_condicao_pgto_12->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_condicao_pgto_12'];
      $this->mgt_faturamento_cliente_observacao->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_observacao'];
      $this->mgt_faturamento_ordem_compra->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_ordem_compra'];

      $this->mgt_faturamento_valor_pedido->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_valor_pedido'];
      $this->mgt_faturamento_valor_frete->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_valor_frete'];
      $this->mgt_faturamento_valor_ipi->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_valor_ipi'];
      $this->mgt_faturamento_valor_total->Text = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_valor_total'];

      $this->mgt_faturamento_cliente_tipo_faturamento->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_tipo_faturamento'];
      $this->mgt_faturamento_cliente_transportadora->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_cliente_transportadora'];
      $this->mgt_faturamento_status->ItemIndex = GetConexaoPrincipal()->SQL_MGT_Faturamentos->Fields['mgt_faturamento_status'];

      $this->MSG_Erro->Caption = "";

      //*** Carrega os Produtos do Faturamento e Totaliza ***
   ...
   function bt_fecharClick($sender, $params)
   {
         ...
         redirect('ven_faturamentos.php');
   }

   function bt_alterar_faturamentoClick($sender, $params)
   {
      ...
      else
      {
         ...
         $Comando_SQL .= "mgt_faturamento_cliente_tipo = '" . trim($this->hd_tipo_adicao->Value) . "',";
         ...
         $Comando_SQL .= "mgt_faturamento_status = '" . trim($this->mgt_faturamento_status->ItemIndex) . "' ";
         ...
         /*
         $Comando_SQL = "select *,date_format(mgt_faturamento_data, '%d/%m/%Y') AS mgt_faturamento_data,date_format(mgt_faturamento_data_entrega, '%d/%m/%Y') AS mgt_faturamento_data_entrega, IF(mgt_faturamento_status = 'Preparando','#','') AS mgt_faturamento_status_1, IF(mgt_faturamento_status = 'Faturado','#','') AS mgt_faturamento_status_2, IF(mgt_faturamento_status = 'Aguardando','#','') AS mgt_faturamento_status_3 from mgt_faturamentos where mgt_faturamento_status <> 'Faturado'";
   ...
   function venfaturamentosaltJSLoad($sender, $params)
   {
...
global $venfaturamentosalt;

//Creates the form
$venfaturamentosalt = new venfaturamentosalt($application);

//Read from resource file
$venfaturamentosalt->loadResource(__FILE__);

//Shows the form
$venfaturamentosalt->show();
