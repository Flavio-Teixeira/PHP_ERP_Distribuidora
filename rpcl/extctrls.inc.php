...
*/
                ...
                if($Mbox)
                {
                  ...
                  echo "<table id=\"{$this->_name}_table\" cellpadding=\"0\" title=\"$hinttext\" cellspacing=\"0\" width=\"$w\" ".($style!=""?"style=\"$style\"":"")." $class $attributes>";
                        ...
                        for($row=0; $row<$itemsPerColumn; ++$row)
                        {
                                ...
                                for($column=0; $column<$itemsPerRow; ++ $column)
                                {
                                        if(!$Mbox)
                                          ...
                                          echo "<td width=\"$columnsWidth\" style=\"height:{$rowHeight}px\"  $alignment>";
                                        ...
                                        if($row+$itemsPerColumn*$column<$numItems)
                                        {
                                                ...
                                                if(!$Mbox)
                                                {
                                                  ...
                                                  echo "<label for=\"{$this->_name}_{$key}\" id=\"{$this->_name}_{$key}_caption\" $spanstyle $hinttext  $class>$item</label>\n";
                                        }
                                        echo "</td>\n";
                                        $index++;
                                }
