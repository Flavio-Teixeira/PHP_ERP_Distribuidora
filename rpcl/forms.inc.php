...
class Application extends Component
{
        ...
        * @link wiki://Developer%27s_Guide_::_Localizing_the_Interface
 ...
 *
 * This class is the foundation of the RPCL, it's
 ...
 *
 * If you use RadPHP XE, Pages are created by the IDE and you drop components inside them,
...
class CustomForm extends CustomPage
{
    ...
    function defaultIcon() { return ""; }
        ...
        * @return integer
        */
        function readFrameSpacing() { return $this->_framespacing;       }
        function writeFrameSpacing($value) { $this->_framespacing=$value; }
        ...
        * @return enum
        */
        function readFrameBorder() { return $this->_frameborder; }
        function writeFrameBorder($value) { $this->_frameborder=$value; }
    ...
    protected $_doctype="dtNone";
        ...
        * @return enum
        */
    function readDocType() { return $this->_doctype; }
    function writeDocType($value) { $this->_doctype=$value; }
    ...
    function defaultFormEncoding() { return ""; }
        ...
        *
        * @link wiki://Developer%27s_Guide_::_Smarty_Templates
        ...
        *
        * @link wiki://Component_Writer%27s_Guide_::_Ajax_Integration
    ...
    function defaultTarget() { return ""; }
     ...
     function isFacebookApp()
     {
        ...
        return(is_object($fbapplication));
     }

     function isFacebookFBMLApp()
     {
        global $fbapplication;

        return(is_object($fbapplication) && ($fbapplication->RenderMethod==rmFBML));
     }

     function isFacebookIFrameApp()
     {
        global $fbapplication;

        return(is_object($fbapplication) && ($fbapplication->RenderMethod==rmIFrame));
     }
 ...
 */
    ...
    * @link wiki://Developer%27s_Guide_::_Smarty_Templates#Accessing_the_internal_Smarty_object
    * @see getTemplateEngine(), getTemplateFilename()
    *
    * @return mixed
    */
    ...
    */
    function dumpHeaderJavascript($return_contents=false)
    {
        ...
        if ($output_enabled)
        {
                ...
                {
                  $sp="<script type=\"text/javascript\" src=\"".RPCL_HTTP_PATH."/js/common.js\"></script>\n";
                  define('COMMON_JS',1);
                }
    ...
    */
    ...
    function dumpContents()
    {
        ...
        //An FBML application must not show any header
        if ($this->isFacebookFBMLApp()) $allowshowheader=false;
        ...
        if ($allowshowheader)
        {
                ...
                if ($this->isFacebookApp()) $extra='xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml"';
...
<script>
  window.fbAsyncInit = function() {
    FB.init({appId: '<?php echo $fbapplication->ApplicationID; ?>', status: true, cookie: true,
             xfbml: true});
  };
  (function() {
...
<?php
        ...
        if (!$this->hasframes)
        {
                if ($this->_showfooter)
                {
                    //An FBML application must not show any footer
                    if (!$this->isFacebookFBMLApp())
                    {
	                    if ($this->_generatedocument)
    	                {
                          $this->dumpEndBody();
...
//                $height="";
    ...
    function defaultGenerateDocument() { return "1"; }
        ...
        * @link wiki://Developer%27s_Guide_::_Page_Inheritance
        *
        * @return boolean
        */
    function readIsMaster() { return $this->_ismaster; }
    function writeIsMaster($value) { $this->_ismaster=$value; }
