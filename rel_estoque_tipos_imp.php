...
//Definicao de classe
class relestoquetiposimp extends Page
{
   ...
   function relestoquetiposimpCreate($sender, $params)
   {
      ...
      $this->qtde_inicial->Caption = $_REQUEST['qtde_inicial'];
      $this->qtde_atual->Caption = $_REQUEST['qtde_atual'];
      $this->tipo_escolhido->Caption = $_REQUEST['tipo_escolhido'];
   }
   function relestoquetiposimpJSLoad($sender, $params)
   {
...
global $relestoquetiposimp;

//Cria o formulario
$relestoquetiposimp = new relestoquetiposimp($application);

//Ler do arquivo de recursos
$relestoquetiposimp->loadResource(__FILE__);

//Mostrar o formulario
$relestoquetiposimp->show();
