...
//Class definition
class nfemissaonotaimpsx extends Page
{
    public $Label133 = null;
    public $Label132 = null;
    public $mgt_nota_fiscal_referenciada = null;
   ...
   public $area_sistema = null;
    ...
    public $mgt_nota_fiscal_tipo_operacao = null;
...
?>
   ...
   {
     document.nfemissaonotaimpsx.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_exportacao_local_emb.focus();
     return false;
   }
...
?>
      ...
      var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_produtos;
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_total.value = (((parseFloat(document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_produtos.value) + parseFloat(document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_frete.value) + parseFloat(document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_seguro.value) + parseFloat(document.nfemissaonotaimpsx.mgt_nota_fiscal_outras_despesas.value) + parseFloat(document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_ipi.value)) - parseFloat(document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_desconto.value))).toFixed(2);
...
?>
      ...
      var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_outras_despesas;
      var digits="0123456789.,";
      var campo_temp;
...
?>
   //Adicione seu codigo javascript aqui
      ...
      if(document.nfemissaonotaimpsx.hd_apenas_registra.value == 0)
      {
         document.nfemissaonotaimpsx.hd_apenas_registra.value = 1;
      }
      else
      {
         document.nfemissaonotaimpsx.hd_apenas_registra.value = 0;
      }
...
<?php
   ...
   public function transmitir_xml()
   {
      ...
      //***********************************************************
      //*** INICIO - Validando o XML (Schema enviNFe_v3.10.xsd) ***
      //***********************************************************
      ...
      $validacao = validaXML('nfe/saida/enviNFe_' . trim($mgt_numero_nfe) . '_sign.xml', 'validadores/enviNFe_v3.10.xsd');
      ...
      if($validacao["status"] == '1')
      {
         ...
         $conteudo_ret_gravar = '<protNFe versao="3.10" xmlns="http://www.portalfiscal.inf.br/nfe">';
         $conteudo_ret_gravar = $conteudo_ret_gravar . '<infProt><tpAmb>' . trim($tipo_ambiente) . '</tpAmb>';
         $conteudo_ret_gravar = $conteudo_ret_gravar . '<verAplic>SP_NFE_PL_008f</verAplic>';
         $conteudo_ret_gravar = $conteudo_ret_gravar . '<chNFe>' . trim($chave_acesso_nro) . '</chNFe>';
         $conteudo_ret_gravar = $conteudo_ret_gravar . '<dhRecbto>' . trim(date("Y-m-d", time())) . 'T' . trim(date("H:i:s", time())) . trim(date("P", time())) . '</dhRecbto>';
         ...
         fwrite($arquivo_cliente, '<?xml version="1.0" encoding="UTF-8"?><nfeProc xmlns="http://www.portalfiscal.inf.br/nfe" versao="3.10">' . trim($conteudo_nf_gravar) . trim($conteudo_ret_gravar) . '</nfeProc>');
         fclose($arquivo_cliente);
   ...
   public function gerar_xml()
   {
      ...
      $a01->setAttribute('versao', '3.10');//*** A02 ***
      ...
      $b09 = $geraDom->createElement('dhEmi', trim(date("Y-m-d", time())) . 'T' . trim(date("H:i:s", time())) . trim(date("P", time())) );

      if((trim($this->mgt_nota_fiscal_data_entrega->Text) <> '')and(trim($this->mgt_nota_fiscal_data_entrega->Text) <> '00/00/0000'))
      {
	     $b10 = $geraDom->createElement('dhSaiEnt', trim(inverte_data_dma_to_amd(trim($this->mgt_nota_fiscal_data_entrega->Text))) . 'T' . trim(date("H:i:s", time())) . trim(date("P", time())) );
	  ...
	  {
		$b11a = $geraDom->createElement('idDest', '3');
	  }
	  elseif(trim($this->mgt_nota_fiscal_estado->Text) == 'SP')
	  {
		$b11a = $geraDom->createElement('idDest', '1');
	  }
	  else
	  {
		$b11a = $geraDom->createElement('idDest', '2');
	  }

      $b12 = $geraDom->createElement('cMunFG', trim($_SESSION['login_cod_cidade']));

      //*** Tag para a Nota Fiscal Referencia para as Finalidades 2, 3 ou 4 ***

      if((trim($this->mgt_nota_fiscal_tipo_operacao->Text) <> '1') And (trim($this->mgt_nota_fiscal_referenciada->Text) <> '') )
      {
         $b12a = $geraDom->createElement('NFref');
         $b13 = $geraDom->createElement('refNFe', trim($this->mgt_nota_fiscal_referenciada->Text));
      }
      ...
      $b25 = $geraDom->createElement('finNFe', trim($this->mgt_nota_fiscal_tipo_operacao->Text));
      $b25a = $geraDom->createElement('indFinal', '0');
      $b25b = $geraDom->createElement('indPres', '9');
	  ...
	  //$c17a = $geraDom->createElement('IM', '', 0));      
      ...
      if(municipios_ibge($this->mgt_nota_fiscal_estado->Text, $this->mgt_nota_fiscal_cidade->Text) <> '9999999')
      {
	      if($ie_cliente <> 'ISENTO')
		  {
			$e17a = $geraDom->createElement('indIEDest', '1');		 
			$e17 = $geraDom->createElement('IE', $ie_cliente);
		  }
		  else
		  {
			 $e17a = $geraDom->createElement('indIEDest', '2');		 
      ...
      $b01->appendChild($b24);
      $b01->appendChild($b25);
	  $b01->appendChild($b25a);
	  $b01->appendChild($b25b);
      $b01->appendChild($b26);
      $b01->appendChild($b27);
               ...
               elseif($situacao_tributaria == 51)
               {
                  if((trim($_SESSION['login_nfe_regime']) <> '1'))
                  {
                     ...
                     $n16 = $geraDom->createElement('pICMS', number_format($aliquota_icms, 2, '.', ''));
	  			     ...
	  			     $n16a = $geraDom->createElement('vICMSOp', number_format(0, 2, '.', ''));
					 $n16b = $geraDom->createElement('pDif', number_format(100, 2, '.', ''));
					 $n16c = $geraDom->createElement('vICMSDif', number_format(0, 2, '.', ''));
                     ...
                     $n02->appendChild($n15);
                     $n02->appendChild($n16);
	  			     $n02->appendChild($n16a);
					 $n02->appendChild($n16b);
					 $n02->appendChild($n16c);
                     $n02->appendChild($n17);
                  }
               }
               elseif($situacao_tributaria == 151)
               {
                  if((trim($_SESSION['login_nfe_regime']) <> '1'))
                  {
                     $n02 = $geraDom->createElement('ICMS51');
      ...
      $w04a = $geraDom->createElement('vICMSDeson', number_format(0, 2, '.', ''));	  
...
?>
      ...
      document.nfemissaonotaimpsx.hd_nota_fiscal_descricao_condicao_pgto.value = document.nfemissaonotaimpsx.mgt_nota_fiscal_descricao_condicao_pgto[document.nfemissaonotaimpsx.mgt_nota_fiscal_descricao_condicao_pgto.selectedIndex].value;
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cfop.focus();
     return false;
   }
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_12;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_11;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_10;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_9;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_8;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_7;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_6;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_5;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_4;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_3;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_2;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_1;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_12
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_11
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_10
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_9
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_8
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_7
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_6
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_5
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_4
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_3
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_2
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_1
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_12.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_11.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_10.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_9.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_8.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_7.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_6.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_5.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_4.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_3.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_2.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
   ...
   document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_forma_1.value = '';
   document.nfemissaonotaimpsx.opcao_vista.value = '';
...
?>
   ...
   if(document.nfemissaonotaimpsx.hd_nota_fiscal_nao_imprimir.value == 0)
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_nao_imprimir.value = 1;
   }
   else
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_nao_imprimir.value = 0;
   }
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_data_emissao
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if(document.nfemissaonotaimpsx.hd_nota_fiscal_zerar_base_icms.value == 0)
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_zerar_base_icms.value = 1;
   }
   else
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_zerar_base_icms.value = 0;
   }

   document.nfemissaonotaimpsx.mgt_nota_fiscal_aliquota_icms.value = '0';
   document.nfemissaonotaimpsx.mgt_nota_fiscal_base_icms.value = '0.00';
   document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_icms.value = '0.00';
...
?>
   ...
   if(document.nfemissaonotaimpsx.hd_nota_fiscal_consumo.value == 0)
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_consumo.value = 1;
   }
   else
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_consumo.value = 0;
   }
...
?>
   ...
   if(document.nfemissaonotaimpsx.hd_nota_fiscal_revenda.value == 0)
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_revenda.value = 1;
   }
   else
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_revenda.value = 0;
   }
...
?>
   ...
   if(document.nfemissaonotaimpsx.hd_nota_fiscal_imprime_observacao_nota.value == 0)
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_imprime_observacao_nota.value = 1;
   }
   else
   {
      document.nfemissaonotaimpsx.hd_nota_fiscal_imprime_observacao_nota.value = 0;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_suframa.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_suframa_desconto_pis_cofins.focus();
     return false;
   }
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_suframa_desconto_pis_cofins;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_suframa_desconto_icms;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_numero.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_codigo.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_nome.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_razao_social.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_inscricao_estadual.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_inscricao_municipal.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_complemento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_bairro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_estado.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cep.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_pais.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fone.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fax.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_endereco_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_complemento_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_bairro_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cidade_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_estado_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cep_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_pais_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fone_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fax_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_endereco_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_complemento_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_bairro_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cidade_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_estado_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cep_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_pais_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fone_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fax_cobranca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_ddd.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fone_comercial.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fone_celular.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_fone_fax.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_email.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_site.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_natureza_operacao_imp.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_data_emissao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_numero.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_suframa_desconto_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cfop_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_nota.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_desconto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_data.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_data_entrega.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_emite_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_natureza_operacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_faturamento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_representante.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_1.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_nro_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_dt_vcto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_dup_vlr_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_observacao_adicional_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_exportacao_uf_emb.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_tipo_transporte.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_razao_social.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_veiculo_placa.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_veiculo_estado.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_cnpj.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_insc_est.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_insc_mun.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_endereco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_complemento.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_bairro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_cidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_estado.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_transportadora_cep.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_qtde.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_especie.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_marca.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_vol_numero.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_peso_bruto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_peso_liquido.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_base_aliquota_icms_reduzida.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_desconto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_base_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_consumo.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_zerar_base_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_icms.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_base_icms_sub.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_icms_sub.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_produtos.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_seguro.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_outras_despesas.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.nfemissaonotaimpsx.mgt_nota_fiscal_valor_total.focus();
     return false;
   }
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_peso_liquido;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_peso_bruto;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_qtde
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cfop_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_cfop
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_numero
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
<?php
            ...
            if($this->hd_nota_fiscal_nao_imprimir->Value == 0)
            {
               ...
               else
               {
                  if($this->hd_apenas_registra->Value == 0)
                  {
                     ...
                     $validacao = validaXML('nfe/saida/enviNFe_' . trim($this->mgt_nota_fiscal_numero->Text) . '_sign.xml', 'validadores/enviNFe_v3.10.xsd');
   ...
   function nfemissaonotaimpsxCreate($sender, $params)
   {
   ...
   function nfemissaonotaimpsxJSLoad($sender, $params)
   {
   ...
   <?php
    ...
    function mgt_nota_fiscal_tipo_operacaoJSKeyPress($sender, $params)
    {
        ?>
        //begin js
        ...
        if((event.keyCode == 9) || (event.keyCode == 13) )
        {
          document.nfemissaonotaimpsx.mgt_nota_fiscal_referenciada.focus();
          return false;
        }
    ...
    function mgt_nota_fiscal_tipo_operacaoJSKeyUp($sender, $params)
    {
        ?>
        //begin js
        ...
        var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_tipo_operacao
        var digits="0123456789"
        var campo_temp
        for (var i=0;i<campo.value.length;i++){
            campo_temp=campo.value.substring(i,i+1)
    ...
    function mgt_nota_fiscal_referenciadaJSKeyPress($sender, $params)
    {
        ?>
        //begin js
    ...
    function mgt_nota_fiscal_referenciadaJSKeyUp($sender, $params)
    {
        ?>
        //begin js
        ...
        var campo = document.nfemissaonotaimpsx.mgt_nota_fiscal_referenciada
        var digits="0123456789"
        var campo_temp
        for (var i=0;i<campo.value.length;i++){
            campo_temp=campo.value.substring(i,i+1)
...
global $nfemissaonotaimpsx;

//Creates the form
$nfemissaonotaimpsx = new nfemissaonotaimpsx($application);

//Read from resource file
$nfemissaonotaimpsx->loadResource(__FILE__);

//Shows the form
$nfemissaonotaimpsx->show();
