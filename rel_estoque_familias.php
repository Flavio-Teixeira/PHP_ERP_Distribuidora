...
//Class definition
class relestoquefamilias extends Page
{
   public $familia_escolhida = null;
   public $Label5 = null;
   ...
   function opcao_estoqueChange($sender, $params)
   {
      ...
      $Comando_SQL = "Select * from mgt_movtos_estoque, mgt_produtos Where mgt_movto_produto_codigo = mgt_produto_codigo And mgt_produto_familia = " . trim($this->opcao_estoque->ItemIndex) . " Order By mgt_movto_estoque_numero";
      ...
      //*** Obtem a Familia do Produto Escolhido ***

      $this->familia_escolhida->Caption = $this->opcao_estoque->Items[$this->opcao_estoque->ItemIndex];
   }

   function relestoquefamiliasCreate($sender, $params)
   {
      ...
      if((GetConexaoPrincipal()->SQL_MGT_Familias->EOF) != 1)
      {
         ...
         {
            $this->opcao_estoque->AddItem(GetConexaoPrincipal()->SQL_MGT_Familias->Fields['mgt_familia_produto_descricao'], null , GetConexaoPrincipal()->SQL_MGT_Familias->Fields['mgt_familia_produto_codigo']);
   ...
   function relestoquefamiliasJSLoad($sender, $params)
   {
...
global $relestoquefamilias;

//Creates the form
$relestoquefamilias = new relestoquefamilias($application);

//Read from resource file
$relestoquefamilias->loadResource(__FILE__);

//Shows the form
$relestoquefamilias->show();
