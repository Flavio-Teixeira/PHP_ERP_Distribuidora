object EnviaCTe: TEnviaCTe
  Left = 259
  Top = 114
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Envio Autom'#225'tico das CT-e e DANFEs'
  ClientHeight = 329
  ClientWidth = 679
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 672
    Height = 187
    Caption = '   Lista de CT-e a serem enviadas   '
    TabOrder = 0
    object DBGrid_Pedidos: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'mgt_cte_numero'
          Title.Caption = 'Nro.CT-e'
        ...
        item
          Expanded = False
          FieldName = 'mgt_cte_destinatario_codigo'
        ...
        item
          Expanded = False
          FieldName = 'mgt_cte_destinatario_razao_social'
        ...
        item
          Expanded = False
          FieldName = 'mgt_cte_servico_valor_receber'
        ...
        item
          Expanded = False
          FieldName = 'mgt_cte_data_entrega'
        ...
        item
          Expanded = False
          FieldName = 'mgt_cte_status_envio'
          Title.Caption = 'Envio'
          Title.Font.Charset = DEFAULT_CHARSET
          Title.Font.Color = clWindowText
          Title.Font.Height = -11
  ...
  object GroupBox2: TGroupBox
    ...
    object Opc_Manual: TRadioButton
      ...
      Height = 17
      Caption = 
        'Envio Manual (Com esta op'#231#227'o '#233' necess'#225'rio escolher a CT-e deseja' +
        'da)'
      TabOrder = 2
