<?php
<object class="relduplicata" name="relduplicata" baseclass="page">
  ...
  <property name="Name">relduplicata</property>
  <property name="Width">755</property>
  <property name="OnCreate">relduplicataCreate</property>
  <property name="jsOnLoad">relduplicataJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE COBRANCA - Duplicata]]></property>
