...
class Layout extends Persistent
{
        ...
        * @param array $exclude Classnames of the controls you want to exclude from dumping
        */
            function dumpBoxedLayout($exclude=array())
            {
              if ($this->_control!=null)
                {
                        reset($this->_control->controls->items);
                        ...
                        while (list($k,$v)=each($arrayOfControls))
                        {
                                ...
                                if ($dump)
                                {
                                        ...
                                        $style="Z-INDEX: $k; LEFT: ".$left."px; WIDTH: ".$aw."px; POSITION: relative; HEIGHT: ".$ah."px;padding:5px;clear:both;";
...
class Canvas extends Persistent
{
        ...
        */
        function initLibrary()
        {
                ...
                if (!defined('JSCANVAS'))
                {
                        echo "<script type=\"text/javascript\" src=\"" . RPCL_HTTP_PATH . "/walterzorn/wz_jsgraphics.js\"></script>\n";
                        define('JSCANVAS', 1);
                }
         ...
         * Begins draw cycle.
         *
         * In RPCL, graphics are drawn on the browser using javascript, and this
