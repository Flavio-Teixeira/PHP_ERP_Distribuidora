...
//Definicao de classe
class venpedidosimp extends Page
{
   ...
   function venpedidosimpCreate($sender, $params)
   {
      ...
      $this->relatorio_titulo->Caption = 'Venda Programada - Nro.: ' . trim($mgt_programada_numero);
   ...
   function venpedidosimpJSLoad($sender, $params)
   {
...
global $venpedidosimp;

//Cria o formulario
$venpedidosimp = new venpedidosimp($application);

//Ler do arquivo de recursos
$venpedidosimp->loadResource(__FILE__);
