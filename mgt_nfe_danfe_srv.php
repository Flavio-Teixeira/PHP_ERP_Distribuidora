...
if(is_file($arquivo_XML))
{
   ...
   $xml_RazaoSocial = utf8_decode($ler_xml->CompNfse->Nfse->InfNfse->PrestadorServico->RazaoSocial);
   $xml_Endereco = utf8_decode($ler_xml->CompNfse->Nfse->InfNfse->PrestadorServico->Endereco->Endereco);
   $xml_Endereco .= ', ' . utf8_decode($ler_xml->CompNfse->Nfse->InfNfse->PrestadorServico->Endereco->Numero);
   $xml_Endereco .= ' - ' . utf8_decode($ler_xml->CompNfse->Nfse->InfNfse->PrestadorServico->Endereco->Bairro);
   $xml_Endereco .= ' - CEP: ' . utf8_decode($ler_xml->CompNfse->Nfse->InfNfse->PrestadorServico->Endereco->Cep);
   ...
   $pdf->Text(50, 64, $xml_RazaoSocial);
   $pdf->Text(50, 71, $xml_Endereco);
   ...
   $pdf->Text(50, 124, $xml_T_RazaoSocial);
   $pdf->Text(50, 131, $xml_T_Endereco);
   ...
   $pdf->RoundedRect(5, 251.5, 200, 29, 0.5, '');
   ...
   $pdf->Text(120, 271, 'Aliquota ISS (%):');
   $pdf->Text(120, 278, 'Valor do ISS (R$):');
   ...
   $pdf->Text(157, 271, number_format($xml_Aliquota, 2, ',', '.'));
   $pdf->Text(157, 278, number_format($xml_ValorIss, 2, ',', '.'));
