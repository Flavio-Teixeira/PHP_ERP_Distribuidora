...
//Definicao de classe
class relcontaspagarefetivoimp extends Page
{
   ...
   function relcontaspagarefetivoimpCreate($sender, $params)
   {
      ...
      $this->opcao_soma_dia->Caption = $_SESSION['opcao_soma_dia'];
      $this->conta_padrao->Caption = $_SESSION['conta_padrao'];

      $opcao_soma_dia = $_SESSION['opcao_soma_dia'];
      ...
      $Comando_SQL .= "values(";
      $Comando_SQL .= "'" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "', ";
      ...
      $Comando_SQL = "Select * from mgt_contas_pagar Where ((mgt_conta_pagar_data >= '" . inverte_data_dma_to_amd(trim($this->mgt_data_inicial->Caption)) . "') And (mgt_conta_pagar_data <= '" . inverte_data_dma_to_amd(trim($this->mgt_data_final->Caption)) . "')) and (mgt_conta_pagar_data_pagto > '0000-00-00') Order By mgt_conta_pagar_data ASC, mgt_conta_pagar_descricao ASC";
      ...
      for($ind = 1; $ind <= 12; $ind++)
      {
         ...
         $Comando_SQL .= ") And (mgt_nota_fiscal_dup_dt_pgto_" . $ind . " > '0000-00-00') Order By mgt_nota_fiscal_dup_dt_vcto_" . $ind . " ASC, mgt_nota_fiscal_numero ASC";
      ...
      for($ind = 1; $ind <= 12; $ind++)
      {
         ...
         $Comando_SQL .= ") And (mgt_programada_dup_dt_pgto_" . $ind . " > '0000-00-00') Order By mgt_programada_dup_dt_vcto_" . $ind . " ASC, mgt_programada_numero ASC";
      ...
      $this->total_saldo->Caption = GetConexaoPrincipal()->SQL_MGT_Comparativo->Fields['mgt_swap_comparativo_saldo'];
   ...
   function relcontaspagarefetivoimpJSLoad($sender, $params)
   {
...
global $relcontaspagarefetivoimp;

//Cria o formulario
$relcontaspagarefetivoimp = new relcontaspagarefetivoimp($application);

//Ler do arquivo de recursos
$relcontaspagarefetivoimp->loadResource(__FILE__);

//Mostrar o formulario
$relcontaspagarefetivoimp->show();
