            ...
            */
            ...
            function dumpHeaderCode()
            {
                ...
                if (!defined('JQUERY_NEWS'))
                {
                    ...
                    echo '<script language="javascript" type="text/javascript" src="'.RPCL_HTTP_PATH.'/jquery/jquery.accessible-news-slider.js"></script>'."\n";
                }
?>
<script language="javascript" type="text/javascript">
jQuery(function() {
    jQuery(".<?php echo $this->_name; ?>").accessNews({
...
?>
    <div class="<?php echo $this->Name; ?>_news_slider <?php echo $this->Name; ?>">
       <div class="news_slider <?php echo $this->Name; ?>">
        ...
        <a href="#" class="prev"><img src="<?php echo RPCL_HTTP_PATH; ?>/jquery/images/prev.gif" width="16" height="16" alt="Previous" title="Previous" env="images" /></a>
        <a href="#" class="next"><img src="<?php echo RPCL_HTTP_PATH; ?>/jquery/images/next.gif" width="16" height="16" alt="Next" title="Next" env="images" /></a>
