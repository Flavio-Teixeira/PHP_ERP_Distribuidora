...
//Class definition
class relcobrancavencido extends Page
{
   ...
   var campo = document.relcobrancavencido.mgt_data_final
   ...
   var campo = document.relcobrancavencido.mgt_data_inicial
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   {
     document.relcobrancavencido.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relcobrancavencido.mgt_data_final.focus();
     return false;
   }
...
<?php
   ...
   function relcobrancavencidoJSLoad($sender, $params)
   {
...
global $relcobrancavencido;

//Creates the form
$relcobrancavencido = new relcobrancavencido($application);

//Read from resource file
$relcobrancavencido->loadResource(__FILE__);

//Shows the form
$relcobrancavencido->show();
