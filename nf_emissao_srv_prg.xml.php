<?php
<object class="nfemissaosrvprg" name="nfemissaosrvprg" baseclass="page">
  ...
  <property name="Name">nfemissaosrvprg</property>
  <property name="Width">755</property>
  <property name="OnCreate">nfemissaosrvprgCreate</property>
  <property name="jsOnLoad">nfemissaosrvprgJSLoad</property>
  ...
  <object class="Label" name="relatorio_titulo" >
    ...
    <property name="Caption"><![CDATA[Venda Programada (Servicos) - Nro.:]]></property>
    <property name="Font">
    ...
    <property name="Width">670</property>
  </object>
  ...
  <object class="Label" name="mgt_programada_valor_desconto" >
    <property name="Alignment">agRight</property>
    <property name="Caption">mgt_programada_valor_desconto</property>
    <property name="DataField">mgt_programada_valor_desconto</property>
    <property name="DataSource">conexaoprincipal.DS_MGT_Programadas</property>
    <property name="Font">
        <property name="Align">taRight</property>
    </property>
    <property name="Height">13</property>
    <property name="Left">209</property>
    <property name="Name">mgt_programada_valor_desconto</property>
    <property name="ParentColor">0</property>
    <property name="ParentFont">0</property>
    <property name="Top">248</property>
    <property name="Width">65</property>
