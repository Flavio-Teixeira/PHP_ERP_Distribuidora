...
RADPHP XE USERS:
      ...
      Embarcadero RadPHP XE product:
        1 - See note above, download and install the Advantage PHP client.
        2 - Copy the following files to the RadPHP\X.X\php\ext directory:
              ace32.dll
              axcws32.dll
              adsloc32.dll
              php_advantage.dll (rename the existing php_advantage.dll.5.x.x file)
        3 - Add the following line to the RadPHP\X.X\php\php.ini.template file:
        ...
        4 - To use: enter "ads" as the DriverName on a connection component, and set
            ...
            and formatting.
        5 - (optional) - Modify the RadPHP\X.X\vcl\packages\database.packages.php
