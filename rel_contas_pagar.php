...
//Class definition
class relcontaspagar extends Page
{
   ...
   var campo = document.relcontaspagar.mgt_data_final
   ...
   var campo = document.relcontaspagar.mgt_data_inicial
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   {
     document.relcontaspagar.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relcontaspagar.mgt_data_final.focus();
     return false;
   }
...
<?php
   ...
   function relcontaspagarJSLoad($sender, $params)
   {
...
global $relcontaspagar;

//Creates the form
$relcontaspagar = new relcontaspagar($application);

//Read from resource file
$relcontaspagar->loadResource(__FILE__);
