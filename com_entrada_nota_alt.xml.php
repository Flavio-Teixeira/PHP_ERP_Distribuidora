<?php
<object class="comentradanotaalt" name="comentradanotaalt" baseclass="Page">
  <property name="Alignment">agLeft</property>
  <property name="Background"></property>
  <property name="Caption"><![CDATA[ManagerTEX - Datatex Informatica e Servicos Ltda - Fone: (11) 2629-4605]]></property>
  <property name="DocType">dtNone</property>
  <property name="Height">1910</property>
  <property name="IsMaster">0</property>
  <property name="Layout">
  <property name="Type">REL_XY_LAYOUT</property>
  </property>
  <property name="Name">comentradanotaalt</property>
  <property name="Width">755</property>
  <property name="OnCreate">comentradanotaaltCreate</property>
  <property name="jsOnLoad">comentradanotaaltJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[NOTAS FISCAIS - Registros de Notas de Entradas - Alteracao/Exclusao]]></property>
  ...
  <object class="GroupBox" name="opcoes_faturamento" >
    ...
    <object class="Button" name="bt_altera_nf" >
      <property name="Caption">Alterar</property>
      <property name="Height">25</property>
      <property name="Left">296</property>
      <property name="Name">bt_altera_nf</property>
      <property name="Top">17</property>
      <property name="Width">75</property>
      <property name="OnClick">bt_altera_nfClick</property>
    </object>
  ...
  <object class="Window" name="confirmacao_exclusao" >
    <property name="Caption"><![CDATA[Confirmacao]]></property>
    <property name="Height">105</property>
    <property name="IsVisible">0</property>
    <property name="Left">188</property>
    <property name="Moveable">0</property>
    <property name="Name">confirmacao_exclusao</property>
    <property name="ResizeMethod">rmOpaque</property>
    <property name="Resizeable">0</property>
    <property name="ShowClose">0</property>
    <property name="ShowMaximize">0</property>
    <property name="ShowMinimize">0</property>
    <property name="Top">1795</property>
    <property name="Width">369</property>
    <object class="Button" name="bt_excluir_nf_nao" >
      <property name="Caption"><![CDATA[Nao]]></property>
      <property name="Height">25</property>
      <property name="Left">108</property>
      <property name="Name">bt_excluir_nf_nao</property>
      <property name="Top">76</property>
      <property name="Width">75</property>
      <property name="OnClick">bt_excluir_nf_naoClick</property>
    </object>
    <object class="Button" name="bt_excluir_nf_sim" >
      <property name="Caption">Sim</property>
      <property name="Height">25</property>
      <property name="Left">187</property>
      <property name="Name">bt_excluir_nf_sim</property>
      <property name="Top">76</property>
      <property name="Width">75</property>
      <property name="OnClick">bt_excluir_nf_simClick</property>
    </object>
  ...
  <object class="HiddenField" name="hd_origem" >
    <property name="Height">18</property>
    <property name="Left">17</property>
    <property name="Name">hd_origem</property>
    <property name="Top">1780</property>
    <property name="Width">20</property>
  </object>
