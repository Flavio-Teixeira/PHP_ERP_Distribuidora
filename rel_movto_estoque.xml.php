<?php
<object class="relmovtoestoque" name="relmovtoestoque" baseclass="page">
  ...
  <property name="Name">relmovtoestoque</property>
  <property name="Width">755</property>
  <property name="OnCreate">relmovtoestoqueCreate</property>
  <property name="jsOnLoad">relmovtoestoqueJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE MOVIMENTO DE ESTOQUE]]></property>
  ...
  <object class="GroupBox" name="GroupBox4" >
    <property name="Caption">Produto Selecionado</property>
