...
//Definicao de classe
class pagcontaspagarrel extends Page
{
   public $Label5 = null;
   public $Label1 = null;
   ...
   function pagcontaspagarrelCreate($sender, $params)
   {
   ...
   function pagcontaspagarrelJSLoad($sender, $params)
   {
...
global $pagcontaspagarrel;

//Cria o formulario
$pagcontaspagarrel = new pagcontaspagarrel($application);

//Ler do arquivo de recursos
$pagcontaspagarrel->loadResource(__FILE__);

//Mostrar o formulario
$pagcontaspagarrel->show();
