<?php
<object class="relcontaspagarefetivo" name="relcontaspagarefetivo" baseclass="page">
  ...
  <property name="Name">relcontaspagarefetivo</property>
  <property name="Width">755</property>
  <property name="OnCreate">relcontaspagarefetivoCreate</property>
  <property name="jsOnLoad">relcontaspagarefetivoJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE CONTAS A PAGAR - Comparativo (Efetivo) a Pagar / a Receber]]></property>
  ...
  <object class="GroupBox" name="GroupBox2" >
    ...
    <property name="Width">730</property>
    <object class="RadioGroup" name="opcao_soma_dia" >
      <property name="Height">42</property>
      <property name="ItemIndex">0</property>
      <property name="Items"><![CDATA[a:2:{i:0;s:72:&quot;Gerar as Contas a Receber Somando 1 Dia na Data de Vencimento Estipulada&quot;;i:1;s:61:&quot;Gerar as Contas a Receber com a Data de Vencimento Estipulada&quot;;}]]></property>
      <property name="Left">16</property>
      <property name="Name">opcao_soma_dia</property>
      <property name="Top">17</property>
      <property name="Width">697</property>
    </object>
    <object class="Label" name="Label4" >
      <property name="Caption"><![CDATA[ATENCAO: Se a Data de Vencimento de um Contas a Receber e Contas a Pagar coincidirem em finais de Semana o Sistema ira Lanca-los na Segunda-Feira.]]></property>
  ...
  <object class="GroupBox" name="GroupBox4" >
    <property name="Caption"><![CDATA[Conta a ser Considerada como Padrao]]></property>
    <property name="Height">106</property>
    <property name="Left">8</property>
    ...
    <object class="Label" name="Label5" >
      <property name="Caption"><![CDATA[ATENCAO: O Sistema ira Considerar a Conta Escolhida Como Padrao, tomando como base o primeiro saldo localizado entre o periodo escolhido. Caso a opcao escolhida seja todas as contas o Sistema somara os primeiros saldos encontrados no periodo informado.]]></property>
    ...
    <object class="ComboBox" name="conta_padrao" >
