...
//Class definition
class relfluxocaixa extends Page
{
   ...
   var campo = document.relfluxocaixa.mgt_data_final
   ...
   var campo = document.relfluxocaixa.mgt_data_inicial
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   {
     document.relfluxocaixa.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relfluxocaixa.mgt_data_final.focus();
     return false;
   }
...
<?php
   ...
   function relfluxocaixaCreate($sender, $params)
   {
      ...
      $this->mgt_data_inicial->Text = '01/01/' . date("Y", time());
   ...
   function relfluxocaixaJSLoad($sender, $params)
   {
...
global $relfluxocaixa;

//Creates the form
$relfluxocaixa = new relfluxocaixa($application);

//Read from resource file
$relfluxocaixa->loadResource(__FILE__);
