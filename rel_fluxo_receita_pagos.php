...
//Class definition
class relfluxoreceitapagos extends Page
{
   ...
   var campo = document.relfluxoreceitapagos.mgt_data_final
   ...
   var campo = document.relfluxoreceitapagos.mgt_data_inicial
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   {
     document.relfluxoreceitapagos.bt_imprimir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relfluxoreceitapagos.mgt_data_final.focus();
     return false;
   }
...
<?php
   ...
   function bt_imprimirClick($sender, $params)
   {
      ...
      if(trim($this->MSG_Erro->Caption) == '')
      {
         ...
         echo "window.open('rel_fluxo_receita_pagos_imp.php','rel_fluxo_receita_pagos_imp','toolbar=yes,location=no,directories=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,maximized=no,fullscreen=no,width=775,innerWidth=775,offsetWidth=775,clientWidth=775,pageWidth=775,height=550,innerHeight=550,offsetHeight=550,clientHeight=550,pageHeight=550');";
         echo "</script>";
      }
   }

   function relfluxoreceitapagosCreate($sender, $params)
   {
   ...
   function relfluxoreceitapagosJSLoad($sender, $params)
   {
...
global $relfluxoreceitapagos;

//Creates the form
$relfluxoreceitapagos = new relfluxoreceitapagos($application);

//Read from resource file
$relfluxoreceitapagos->loadResource(__FILE__);

//Shows the form
$relfluxoreceitapagos->show();
