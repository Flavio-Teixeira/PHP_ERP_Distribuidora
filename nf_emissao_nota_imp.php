...
<?php
   ...
   public function transmitir_xml()
   {
      ...
      if($status_servico)
      {
         ...
         if($validacao["status"] == '1')
         {
            ...
            if(trim($MSG_Erro) == 'Lote recebido com sucesso')
            {
               ...
               //*** gerar o codigo ***
               $geraDomRet->formatOutput = false;// Se True Prevalece a Formatacao com Estrutura (Pulando Linha e Espacos).
               ...
               if($validacao["status"] == '1')
               {
                  ...
                  while($verifica_novamente == true)
                  {
                     ...
                     else
                     {
                        ...
                        {
                           $listagem_erros = 'Lote em processamento: O Sistema Transmitira Novamente, clique em OK.';
                        ...
                        else if(trim($MSG_Erro) == 'Rejeicao: Duplicidade de NF-e')
                        {
                           $listagem_erros = 'Rejeicao - Duplicidade de NF-e: Por favor, altere a numeracao da Ultima Nota Emitida e Tente enviar novamente.';
                        ...
                        {
                           $listagem_erros = 'ATENCAO: Foram Encontrados Erros no XML: \n\n' . $MSG_Erro . '. Corrija o Problema e Tente enviar novamente.';
      ...
      else
      {
         if($this->hd_nota_fiscal_nao_imprimir->Value <> 0)
         {
            ...
            $Comando_SQL = "update mgt_faturamentos set ";
            $Comando_SQL .= "mgt_faturamento_status = 'Contingencia' ";
            $Comando_SQL .= "Where mgt_faturamento_numero = '" . trim($this->mgt_nota_fiscal_faturamento->Text) . "'";
   ...
   public function gerar_xml()
   {
	  ...
	  if($this->hd_nota_fiscal_consumo->Value == 1)
	  {
		  $b25a = $geraDom->createElement('indFinal', '1');
	  }
	  else
	  {
