<?php
<object class="relconhecimentosgerados" name="relconhecimentosgerados" baseclass="page">
  ...
  <property name="Name">relconhecimentosgerados</property>
  <property name="Width">755</property>
  <property name="OnCreate">relconhecimentosgeradosCreate</property>
  <property name="jsOnLoad">relconhecimentosgeradosJSLoad</property>
  <object class="Label" name="area_sistema" >
    <property name="Caption"><![CDATA[RELATORIO DE VENDAS - Total de Conhecimentos Gerados]]></property>
  ...
  <object class="GroupBox" name="GroupBox3" >
    ...
    <object class="Label" name="Label1" >
      <property name="Alignment">agLeft</property>
      <property name="Caption"><![CDATA[Informe o Periodo desejado: de]]></property>
      <property name="Height">13</property>
