...
//Class definition
class relvendasrepresentantes extends Page
{
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relvendasrepresentantes.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.relvendasrepresentantes.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   document.relvendasrepresentantes.representante_codigo.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
   document.relvendasrepresentantes.representante_nome.value = registros.getTableModel().getValue(1, registros.getFocusedRow());
...
<?php
   ...
   function relvendasrepresentantesCreate($sender, $params)
   {
   ...
   function relvendasrepresentantesJSLoad($sender, $params)
   {
...
global $relvendasrepresentantes;

//Creates the form
$relvendasrepresentantes = new relvendasrepresentantes($application);

//Read from resource file
$relvendasrepresentantes->loadResource(__FILE__);

//Shows the form
$relvendasrepresentantes->show();
