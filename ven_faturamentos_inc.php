...
//Class definition
class venfaturamentosinc extends Page
{
    public $Label74 = null;
   ...
   //Adicione seu codigo javascript aqui
      ...
      document.venfaturamentosinc.adiciona_fornecedor_numero.value = registros_fornecedores.getTableModel().getValue(0, registros_fornecedores.getFocusedRow());
      document.venfaturamentosinc.adiciona_fornecedor_codigo.value = registros_fornecedores.getTableModel().getValue(1, registros_fornecedores.getFocusedRow());
      document.venfaturamentosinc.adiciona_fornecedor_nome.value = registros_fornecedores.getTableModel().getValue(2, registros_fornecedores.getFocusedRow());

      document.venfaturamentosinc.hd_faturamento_cliente_desconto.value = '0';
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_1.value = '0';
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_2.value = '0';
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_3.value = '0';
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_4.value = '0';
      document.venfaturamentosinc.hd_faturamento_cliente_transportadora.value = '0';
      document.venfaturamentosinc.hd_faturamento_cliente_observacao.value = '';
   ...
   {
     document.venfaturamentosinc.bt_buscar_fornecedor.focus();
     return false;
   }
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.opcao_busca_fornecedor.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_alterar_produto_ipi;
   ...
   document.venfaturamentosinc.mgt_alterar_produto_valor_total.value = (document.venfaturamentosinc.mgt_alterar_produto_qtde.value * document.venfaturamentosinc.mgt_alterar_produto_preco.value).toFixed(2);
   document.venfaturamentosinc.mgt_alterar_produto_valor_ipi.value   = ((document.venfaturamentosinc.mgt_alterar_produto_valor_total.value * document.venfaturamentosinc.mgt_alterar_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.bt_alterar_sim.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_alterar_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_alterar_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_alterar_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_alterar_produto_lote.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_alterar_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_alterar_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_alterar_produto_qtde.focus();
     return false;
   }
...
?>
      ...
      document.venfaturamentosinc.produto_remover_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.produto_remover_numero_faturamento.value = document.venfaturamentosinc.mgt_faturamento_numero.value;
      document.venfaturamentosinc.produto_remover_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.produto_remover_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());

      //*** Para Alteracao ***

      document.venfaturamentosinc.hd_alterar_produto_numero.value = registros_produtos.getTableModel().getValue(6, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_codigo.value = registros_produtos.getTableModel().getValue(1, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_referencia.value = registros_produtos.getTableModel().getValue(2, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_descricao.value = registros_produtos.getTableModel().getValue(3, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_qtde.value = registros_produtos.getTableModel().getValue(0, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_preco.value = registros_produtos.getTableModel().getValue(4, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_valor_total.value = registros_produtos.getTableModel().getValue(5, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_lote.value = registros_produtos.getTableModel().getValue(7, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_unidade.value = registros_produtos.getTableModel().getValue(8, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_ipi.value = registros_produtos.getTableModel().getValue(9, registros_produtos.getFocusedRow());
      document.venfaturamentosinc.hd_alterar_produto_valor_ipi.value = registros_produtos.getTableModel().getValue(10, registros_produtos.getFocusedRow());
	  document.venfaturamentosinc.hd_alterar_produto_codigo_barras.value = registros_produtos.getTableModel().getValue(11, registros_produtos.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_tipo_faturamento.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venfaturamentosinc.mgt_produto_descricao.value   = registros_produtos_busca.getTableModel().getValue(2, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_preco.value       = registros_produtos_busca.getTableModel().getValue(3, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_lote.value        = registros_produtos_busca.getTableModel().getValue(4, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_unidade.value     = registros_produtos_busca.getTableModel().getValue(5, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_ipi.value         = registros_produtos_busca.getTableModel().getValue(6, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_codigo.value      = registros_produtos_busca.getTableModel().getValue(0, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_referencia.value  = registros_produtos_busca.getTableModel().getValue(1, registros_produtos_busca.getFocusedRow());
      document.venfaturamentosinc.mgt_produto_qtde.value        = '0';
      document.venfaturamentosinc.mgt_produto_valor_total.value = '0.00';
      document.venfaturamentosinc.mgt_produto_valor_ipi.value   = '0.00';
	  document.venfaturamentosinc.mgt_produto_codigo_barras.value = registros_produtos_busca.getTableModel().getValue(7, registros_produtos_busca.getFocusedRow());
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.bt_adicionar_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_produto_ipi.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_produto_unidade.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_produto_lote.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_produto_preco.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_produto_qtde.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_produto_ipi;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
   ...
   document.venfaturamentosinc.mgt_produto_valor_total.value = (document.venfaturamentosinc.mgt_produto_qtde.value * document.venfaturamentosinc.mgt_produto_preco.value).toFixed(2);
   document.venfaturamentosinc.mgt_produto_valor_ipi.value   = ((document.venfaturamentosinc.mgt_produto_valor_total.value * document.venfaturamentosinc.mgt_produto_ipi.value) / 100).toFixed(2);
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_produto_preco;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_produto_qtde;
   var digits="0123456789.,";
   var campo_temp;
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1);
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.bt_busca_produto.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.opcao_busca_produto.focus();
     return false;
   }
...
?>
   //Adicione seu codigo javascript aqui
      ...
      document.venfaturamentosinc.adiciona_cliente_numero.value = registros.getTableModel().getValue(0, registros.getFocusedRow());
      document.venfaturamentosinc.adiciona_cliente_codigo.value = registros.getTableModel().getValue(2, registros.getFocusedRow());
      document.venfaturamentosinc.adiciona_cliente_nome.value = registros.getTableModel().getValue(3, registros.getFocusedRow());
      document.venfaturamentosinc.adiciona_cliente_bloqueado.value = registros.getTableModel().getValue(12, registros.getFocusedRow());

      if(registros.getTableModel().getValue(12, registros.getFocusedRow()) == 'S')
      {
        document.venfaturamentosinc.MSG_Alerta.value = '(Credito Bloqueado)';
      }
      else
      {
        document.venfaturamentosinc.MSG_Alerta.value = '';
      }

      document.venfaturamentosinc.hd_faturamento_cliente_desconto.value = registros.getTableModel().getValue(5, registros.getFocusedRow());
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_1.value = registros.getTableModel().getValue(6, registros.getFocusedRow());
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_2.value = registros.getTableModel().getValue(7, registros.getFocusedRow());
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_3.value = registros.getTableModel().getValue(8, registros.getFocusedRow());
      document.venfaturamentosinc.hd_faturamento_cliente_condicao_pgto_4.value = registros.getTableModel().getValue(9, registros.getFocusedRow());
      document.venfaturamentosinc.hd_faturamento_cliente_transportadora.value = registros.getTableModel().getValue(10, registros.getFocusedRow());
      document.venfaturamentosinc.hd_faturamento_cliente_observacao.value = registros.getTableModel().getValue(11, registros.getFocusedRow());
<?php
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.bt_buscar.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.opcao_busca.focus();
     return false;
   }
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_data_entrega
   var digits="0123456789/"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venfaturamentosinc.mgt_faturamento_cliente_desconto;
      var digits="0123456789.,";
      var campo_temp;
      ...
      //*** Totaliza o Faturamento ***
      if(document.venfaturamentosinc.mgt_faturamento_cliente_desconto.value == '')
      {
         document.venfaturamentosinc.mgt_faturamento_cliente_desconto.value = 0;
      }
      document.venfaturamentosinc.mgt_faturamento_valor_desconto.value = ((parseFloat(document.venfaturamentosinc.mgt_faturamento_valor_pedido.value) * parseFloat(document.venfaturamentosinc.mgt_faturamento_cliente_desconto.value)) / 100).toFixed(2);
      document.venfaturamentosinc.mgt_faturamento_valor_total.value = (parseFloat(document.venfaturamentosinc.mgt_faturamento_valor_pedido.value) - parseFloat(document.venfaturamentosinc.mgt_faturamento_valor_desconto.value) + parseFloat(document.venfaturamentosinc.mgt_faturamento_valor_frete.value) + parseFloat(document.venfaturamentosinc.mgt_faturamento_valor_ipi.value)).toFixed(2);
...
?>
   //Adicione seu codigo javascript aqui
      ...
      var campo = document.venfaturamentosinc.mgt_faturamento_valor_frete;
      var digits="0123456789.,";
      var campo_temp;
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_12
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_11
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_10
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_9
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_8
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_7
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_6
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_5
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_4
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_3
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_2
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   var campo = document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_1
   var digits="0123456789"
   var campo_temp
   for (var i=0;i<campo.value.length;i++){
       campo_temp=campo.value.substring(i,i+1)
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_valor_frete.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_12.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_11.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_10.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_9.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_8.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_7.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_6.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_5.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_4.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_3.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_condicao_pgto_2.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.bt_incluir.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_observacao.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_ordem_compra.focus();
     return false;
   }
...
?>
   ...
   if((event.keyCode == 9) || (event.keyCode == 13) )
   {
     document.venfaturamentosinc.mgt_faturamento_cliente_transportadora.focus();
     return false;
   }
...
<?php
   ...
   function venfaturamentosincCreate($sender, $params)
   {
   ...
   function bt_incluirClick($sender, $params)
   {
      ...
      else
      {
         ...
         $Comando_SQL .= "mgt_faturamento_valor_pedido = '" . trim($this->mgt_faturamento_valor_total->Text) . "',";
         ...
         //*** Ajusta os Valores dos Produtos ***
         //*** Valor Unitario ***
         $Comando_SQL = "update mgt_faturamentos_produtos set ";
         $Comando_SQL .= "mgt_faturamento_produto_valor_unitario = (mgt_faturamento_produto_valor_unitario - ((mgt_faturamento_produto_valor_unitario * " . $this->mgt_faturamento_cliente_desconto->Text . ") / 100)) ";
         $Comando_SQL .= "where mgt_faturamento_produto_numero = mgt_faturamento_produto_numero And mgt_faturamento_produto_numero_pedido = '" . trim($this->mgt_faturamento_numero->Text) . "'";
         ...
         //*** Valor Total ***
         $Comando_SQL = "update mgt_faturamentos_produtos set ";
         $Comando_SQL .= "mgt_faturamento_produto_valor_total = (mgt_faturamento_produto_quantidade * mgt_faturamento_produto_valor_unitario) ";
         $Comando_SQL .= "where mgt_faturamento_produto_numero = mgt_faturamento_produto_numero And mgt_faturamento_produto_numero_pedido = '" . trim($this->mgt_faturamento_numero->Text) . "'";
   ...
   function venfaturamentosincJSLoad($sender, $params)
   {
...
global $venfaturamentosinc;

//Creates the form
$venfaturamentosinc = new venfaturamentosinc($application);

//Read from resource file
$venfaturamentosinc->loadResource(__FILE__);

//Shows the form
$venfaturamentosinc->show();
