        ...
        class phpBB extends FocusControl
        {
            ...
            function defaultPassword() { return ""; }
                ...
                function __construct($aowner=null)
                {
                        ...
                        if ($this->owner!=null)
                        {
                                setRawCookie('phpbb_rpcl_include',$this->owner->lastresourceread);
                                setRawCookie('phpbb_rpcl_form',$this->owner->Name);
                        }
                }
                ...
                function setName($value)
                {
                        ...
                        {
                                setRawCookie('phpbb_rpcl_object',$this->Name);
                        }
                }
                ...
                {
                        ?>
                        <script language="JavaScript" src="<?php echo RPCL_HTTP_PATH; ?>/js/iframe.js"></script>
                        <?php
                }
                ...
                function dumpContents()
                {
                        if (($this->ControlState & csDesigning)==csDesigning)
                        {
                                ...
                                echo "<img src=\"".RPCL_HTTP_PATH."/thirdparty/phpBB2/templates/subSilver/images/logo_phpBB.gif\">";
                                echo "<td></tr></table>\n";
                        }
                        else
                        {
                                echo "<iframe id=\"$this->Name\" src=\"".RPCL_HTTP_PATH."/thirdparty/phpBB2/index.php\" scrolling=\"no\" marginwidth=\"0\" marginheight=\"0\" frameborder=\"0\" vspace=\"0\" hspace=\"0\" style=\"overflow:visible; width:$this->Width;display:none;\"></iframe>";
